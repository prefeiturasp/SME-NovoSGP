...
begin
	...
	for pendencia_db in 
		select p.id as PendenciaId, pa.aula_id as AulaId, u.rf_codigo as ProfessorRf,
			   p.criado_em as CriadoEm, p.criado_por as CriadoPor, p.criado_rf as CriadoRf, 
            ...
            where p.tipo = 9 and not p.excluido
  	loop
  		insert into pendencia_diario_bordo (pendencia_id, aula_id, professor_rf, criado_em, 
  		...
  		values (pendencia_db.PendenciaId, pendencia_db.AulaId, pendencia_db.ProfessorRf, 
  				pendencia_db.CriadoEm, pendencia_db.CriadoPor, pendencia_db.CriadoRf,
  	    		pendencia_db.AlteradoEm, pendencia_db.AlteradoPor, pendencia_db.AlteradoRf);
