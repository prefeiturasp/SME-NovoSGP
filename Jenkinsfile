pipeline {
    ...
    stages {
         ...
         stage('Sonar & Testes') {
         when { anyOf { branch 'master_'; branch 'main_'; branch "story/*"; branch 'development_'; branch 'develop'; branch 'release'; branch 'homolog'; branch 'homolog-r2'; branch 'release-r2';  } }
          parallel {
