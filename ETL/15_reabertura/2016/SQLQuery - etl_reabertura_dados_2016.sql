...
--		 and YEAR(evt_dataInicio) = c.cal_ano
		 /*and (evt_nome not like ('%retifica%') AND
	      ...
	      and((tpc_id = 1 and (evt_dataInicio not between '2016-04-01' and '2016-05-30'))
		  or (tpc_id = 2 and (evt_dataInicio not between '2016-06-01' and '2016-07-30'))
		  or (tpc_id = 3 and (evt_dataInicio not between '2016-09-01' and '2016-10-30'))
		  or (tpc_id = 4 and (evt_dataInicio not between '2016-11-01' and '2016-12-22')))
