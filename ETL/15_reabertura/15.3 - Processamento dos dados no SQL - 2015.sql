...
truncate table truncate table etl_sgp_periodo_fechamento
...
where    tev_id = 1
	...
	--		  evt_nome not like ('Fech%')AND
	      ...
	      and((tpc_id = 1 and (evt_dataInicio between '2015-04-01' and '2015-05-30'))
		  or (tpc_id = 2 and (evt_dataInicio between '2015-06-01' and '2015-07-30'))
		  or (tpc_id = 3 and (evt_dataInicio between '2015-09-01' and '2015-10-30'))
		  or (tpc_id = 4 and (evt_dataInicio between '2015-11-01' and '2015-12-22')))
