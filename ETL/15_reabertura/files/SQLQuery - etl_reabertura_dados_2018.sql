...
where    tev_id = 1
	...
	--	 and YEAR(evt_dataInicio) = c.cal_ano
		 /*and (evt_nome not like ('%retifica%') AND
	      ...
	      and((tpc_id = 1 and (evt_dataInicio not between '2018-04-01' and '2018-05-30'))
		  or (tpc_id = 2 and (evt_dataInicio not between '2018-06-01' and '2018-07-30'))
		  or (tpc_id = 3 and (evt_dataInicio not between '2018-09-01' and '2018-10-30'))
		  or (tpc_id = 4 and (evt_dataInicio not between '2018-11-01' and '2018-12-22')))
		  and es.esc_codigo in ('019455','094765')
		  order by c.cal_descricao,ev.tpc_id
--
USE GestaoPedagogica
select * from ACA_CalendarioAnual 
where cal_ano = 2018
where cal_id in (7,8,9)
