...
CASE  
	WHEN (CHARINDEX('EJA',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao)) = 0 THEN 7 -- não é EJA nem 2018
	 	 ELSE CASE WHEN (CHARINDEX('EJA',c.cal_descricao) + CHARINDEX('2018',c.cal_descricao)) = 0 THEN 10 
				   WHEN (CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao))= 23 THEN 8	
				   WHEN (CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao))= 0 THEN 9
				   WHEN (CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao))=58 THEN 11
				   WHEN (CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao))=35 THEN 12

		 END
END											as tipo_calendario_id,
--CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao)) AS S12019,
--(CHARINDEX('1° Semestre',c.cal_descricao) + CHARINDEX('2019',c.cal_descricao)) AS S22019,
