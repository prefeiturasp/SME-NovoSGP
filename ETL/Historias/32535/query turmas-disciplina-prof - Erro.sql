...
select distinct 
                    ...
                    where  te.st_turma_escola in ('O', 'A', 'C')
					 ...
					 AND   etapa_ensino.cd_etapa_ensino NOT IN( 1 )
				 ...
				 inner join tmp_tbl_gc_erro_pe erro on erro.TurmaId = resultado.TurmaId and erro.ComponenteCurricularId = resultado.ComponenteCurricularId