...
-- Descricao: Insere modulo e permissionamento para Diário de Bordo

BEGIN TRY
    BEGIN TRAN
	PRINT 'Permissionamento do Diário de Bordo - INÍCIO'
	
	--Modulo
	-- insere modulo 57 - Diário de Bordo caso nao exista
	...
	-- insere mapeamento de modulo para o modulo 57 - Diário de Bordo
	IF NOT EXISTS(select * from SYS_ModuloSiteMap where sis_id = 1000 AND mod_id = 57 AND msm_id = 57)
	BEGIN
		INSERT INTO SYS_ModuloSiteMap(sis_id, mod_id, msm_id, msm_nome, msm_descricao, msm_url, msm_informacoes, msm_urlHelp) VALUES (1000, 57,57, 'Diário de Bordo', NULL, '~/', NULL, NULL)
	END


	--Permissoes
	-- insere permissão do Diário de Bordo para perfil Professor Ed. Infantil
	...
	-- insere permissão do Diário de Bordo para perfil Professor CJ Ed. Infantil
	...
	-- insere permissão do Diário de Bordo para perfil ADM UE
	...
	-- insere permissão do Diário de Bordo para perfil CP
	...
	-- insere permissão do Diário de Bordo para perfil AD
	...
	-- insere permissão do Diário de Bordo para perfil Diretor
	...
	-- insere permissão do Diário de Bordo para perfil DRE Básico
	...
	-- insere permissão do Diário de Bordo para perfil ADM DRE
	...
	-- insere permissão do Diário de Bordo para perfil DIPED
	...
	-- insere permissão do Diário de Bordo para perfil PAAI
	...
	-- insere permissão do Diário de Bordo para perfil CEFAI
	...
	-- insere permissão do Diário de Bordo para perfil NAAPA
	...
	-- insere permissão do Diário de Bordo para perfil Diretor DIPED
	...
	-- insere permissão do Diário de Bordo para perfil Supervisor
	...
	-- insere permissão do Diário de Bordo para perfil Supervisor Consulta
	...
	-- insere permissão do Diário de Bordo para perfil Supervisor Técnico
	...
	-- insere permissão do Diário de Bordo para perfil Diretor Regional
	...
	-- insere permissão do Diário de Bordo para perfil COPED Básico
	...
	-- insere permissão do Diário de Bordo para perfil NTC - NAAPA
	...
	-- insere permissão do Diário de Bordo para perfil NTC
	...
	-- insere permissão do Diário de Bordo para perfil NTA
	...
	-- insere permissão do Diário de Bordo para perfil DIEE
	...
	-- insere permissão do Diário de Bordo para perfil DIEJA
	...
	-- insere permissão do Diário de Bordo para perfil DIEI
	...
	-- insere permissão do Diário de Bordo para perfil DIEFM
	...
	-- insere permissão do Diário de Bordo para perfil COPED
	...
	-- insere permissão do Diário de Bordo para perfil ADM SME
	...
	-- insere permissão do Diário de Bordo para perfil ADM COTIC
    ...
    PRINT 'Permissionamento do Diário de Bordo - FIM'
