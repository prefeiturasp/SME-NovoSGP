[Environment]::SetEnvironmentVariable("Sentry__DSN", "https://e7979bdfffa2484e9eab9a58d029a24c@sentry.io/1523241", "Machine")
...
[Environment]::SetEnvironmentVariable("UsuarioGithub", "flavioricardo", "Machine")
[Environment]::SetEnvironmentVariable("SenhaGithub", "fRBM5fc802d2", "Machine")
