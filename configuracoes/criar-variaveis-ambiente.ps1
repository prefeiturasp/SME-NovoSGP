[Environment]::SetEnvironmentVariable("Sentry__DSN", "https://fc79cb08e9684fa39444b964f1d460b8@o283242.ingest.sentry.io/5285311", "Machine")
...
[Environment]::SetEnvironmentVariable("UsuarioGithub", "nogueiraamcom", "Machine")
[Environment]::SetEnvironmentVariable("SenhaGithub", "Club0810", "Machine")
...
[Environment]::SetEnvironmentVariable("ApiKeyEolApi", "074c047807a16c06fe78966214ba533244e4ca6d", "Machine")
