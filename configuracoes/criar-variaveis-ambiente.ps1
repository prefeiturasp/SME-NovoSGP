...
[Environment]::SetEnvironmentVariable("UrlApiGithub", "https://api.github.com/repos/prefeiturasp/SME-NovoSGP/tags", "Machine")
[Environment]::SetEnvironmentVariable("UsuarioGithub", "rodrigo-galante-amcom", "Machine")
[Environment]::SetEnvironmentVariable("SenhaGithub", "@Amcom2020", "Machine")
