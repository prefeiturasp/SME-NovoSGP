namespace SME.SGP.Infra
{
    public class RotasRabbitSgpPainelEducacional
    {
        ...
        public const string ConsolidarFrequenciaDiariaPainelEducacional = "sgp.consolidacao.painel.educacional.frequencia.diaria-teste";
        public const string ConsolidarFrequenciaSemanalPainelEducacional = "sgp.consolidacao.painel.educacional.frequencia.semanal-teste";
