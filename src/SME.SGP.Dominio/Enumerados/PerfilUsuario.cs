...
namespace SME.SGP.Dominio
{
    public enum PerfilUsuario
    {
        ...
        [Display(Name = "76e1e074-37d6-e911-abd6-f81654fe895d")]
        COORDENADOR_PEDAGOGICO_CIEJA = 36,

        [Display(Name = "77e1e074-37d6-e911-abd6-f81654fe895d")]
