namespace SME.SGP.Dominio.Constantes
{
    public static class NomeChaveCache
    {
        ...
        public const string CHAVE_NOTA_CONCEITO_FECHAMENTO_TURMA_TODOS_BIMESTRES_E_FINAL = "nota-conceito-fechamento-turmacodigo-todos-bimestres-e-final:{0}-{1}";
        public const string CHAVE_NOTA_CONCEITO_CONSELHO_CLASSE_TURMA_BIMESTRE = "nota-conceito-conselho-classe-turmacodigo-bimestre:{0}-{1}-{2}";
