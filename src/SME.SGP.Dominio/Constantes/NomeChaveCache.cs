namespace SME.SGP.Dominio.Constantes
{
    public static class NomeChaveCache
    {
        ...
        public const string CHAVE_NOTA_CONSOLIDACAO_CONSELHO_CLASSE_TURMA_COMPONENTE_BIMESTRE_ALUNO = "nota-consolidacao_conselho_classe-turma-componente-bimestre-aluno:{0}-{1}-{2}-{3}";
    }
}
