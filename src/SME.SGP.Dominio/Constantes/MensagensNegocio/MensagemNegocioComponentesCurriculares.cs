...
{
    public class MensagemNegocioComponentesCurriculares
    {
        protected MensagemNegocioComponentesCurriculares() { }

        public const string NAO_FORAM_ENCONTRADOS_COMPONENTES_CURRICULARES_REGENCIA_INFORMADA = "Não foram encontrados componentes curriculares para a regência informada.";
