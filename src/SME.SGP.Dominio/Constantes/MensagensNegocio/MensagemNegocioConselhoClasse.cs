namespace SME.SGP.Dominio.Constantes.MensagensNegocio
{
    public static class MensagemNegocioConselhoClasse
    {
        ...
        public const string NAO_PERMITE_ACESSO_ABA_FINAL_SEM_CONCLUIR_CONSELHO_BIMESTRE = "Para acessar esta aba você precisa concluir o conselho de classe do {0}º bimestre.";
        public const string NAO_PERMITE_ACESSO_ABA_SEM_REGISTRAR_CONSELHO_BIMESTRE = "Para acessar este aba você precisa registrar o conselho de classe do {0}º bimestre";
        public const string ALUNO_NAO_ENCONTRADO_PARA_SALVAR_CONSELHO_CLASSE = "Aluno não encontrado para salvar o conselho de classe.";
        public const string ALUNO_NAO_POSSUI_CONSELHO_CLASSE_ULTIMO_BIMESTRE = "Aluno não possui conselho de classe do último bimestre";
        ...
        public const string LIMPAR_PARECER_CONCLUSIVO_APENAS_ALUNO_INATIVO = "Permitido limpar parecer conclusivo apenas para alunos inativos.";
