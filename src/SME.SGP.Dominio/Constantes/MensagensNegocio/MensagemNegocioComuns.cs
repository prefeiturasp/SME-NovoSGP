...
namespace SME.SGP.Dominio.Constantes.MensagensNegocio
{
    public class MensagemNegocioComuns
    {
        ...
        public const string APENAS_EH_POSSIVEL_CONSULTAR_ESTE_REGISTRO_POIS_O_PERIODO_NAO_ESTA_EM_ABERTO = "Apenas é possível consultar este registro pois o período não está em aberto.";
        public const string A_AUDITORIA_NAO_FOI_REGISTRADA_PELO_ADMINISTRADOR = "A auditoria não foi registrada pelo administrador.";
