            ...
            else
            {
                ...
                else
                {
                    return (from a in aulas
                            ...
                            where a.ProfessorRf == CodigoRf &&
                                  (!string.IsNullOrWhiteSpace(ccp.codigoTerritorioSaber) && (ccp.codigoTerritorioSaber.Equals(a.DisciplinaId) || ccp.codigo.Equals(a.DisciplinaId))) ||
