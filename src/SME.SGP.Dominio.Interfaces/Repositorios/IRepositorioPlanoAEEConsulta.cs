...
namespace SME.SGP.Dominio.Interfaces
{
    ...
    {
        Task<PaginacaoResultadoDto<PlanoAEEAlunoTurmaDto>> ListarPaginado(long dreId, long ueId, long turmaId, string alunoCodigo, int? situacao, string[] turmasCodigos, Paginacao paginacao);
