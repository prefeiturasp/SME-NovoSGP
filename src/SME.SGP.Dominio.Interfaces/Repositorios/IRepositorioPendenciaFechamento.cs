...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioPendenciaFechamento : IRepositorioBase<PendenciaFechamento>
    {
        ...
        Task<bool> PossuiFechamentoPorTurmaComponenteBimestre(long turmaId, int bimestre, long componenteCurricularId);
        ...
        Task<IEnumerable<long>> ObterIdPendenciaFechamentoAprovadaResolvida(long fechamentoId, TipoPendencia tipoPendencia);
    }
}
