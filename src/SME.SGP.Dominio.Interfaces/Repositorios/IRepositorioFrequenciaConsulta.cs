...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioFrequenciaConsulta : IRepositorioBase<RegistroFrequencia>
    {
        ...
        Task<PaginacaoResultadoDto<AlunoFrequenciaTurmaEvasaoDto>> ObterAlunosDashboardFrequenciaTurmaEvasaoAbaixo50PorcentoPaginado(int mes, int anoLetivo, string dreCodigo, string ueCodigo, string turmaCodigo, Modalidade modalidade, int semestre, Paginacao paginacao);
        Task<PaginacaoResultadoDto<AlunoFrequenciaTurmaEvasaoDto>> ObterAlunosDashboardFrequenciaTurmaEvasaoSemPresencaPaginado(int mes, int anoLetivo, string dreCodigo, string ueCodigo, string turmaCodigo, Modalidade modalidade, int semestre, Paginacao paginacao);
    }
}