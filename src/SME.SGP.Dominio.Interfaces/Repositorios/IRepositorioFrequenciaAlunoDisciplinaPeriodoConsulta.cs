...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioFrequenciaAlunoDisciplinaPeriodoConsulta
    {
        ...
        Task<IEnumerable<FrequenciaAluno>> ObterListaDeFrequenciaAlunoPorDisciplinaData(List<string> listaDeCodigoAluno, string disciplinaId, DateTime dataAtual, string turmaCodigo = "");
    }
}
