...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioFrequenciaAlunoDisciplinaPeriodoConsulta
    {
        ...
        Task<IEnumerable<FrequenciaAlunoDto>> ObterRegistroFrequenciaAlunosPorTurmaDisciplinaEPeriodoEscolarProfessor(string codigoTurma, string[] componentesCurricularesId, IEnumerable<long> periodosEscolaresIds, string RfProfessorTerritorioSaber = null);
