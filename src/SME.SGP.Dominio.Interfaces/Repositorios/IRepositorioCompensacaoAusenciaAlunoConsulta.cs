...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioCompensacaoAusenciaAlunoConsulta : IRepositorioBase<CompensacaoAusenciaAluno>
    {
        ...
        Task<IEnumerable<CompensacaoAusenciaAluno>> ObterCompensacoesAusenciasAlunosPorRegistroFrequenciaAlunoIdQuery(IEnumerable<long> registroFrequenciaAlunoIds);
    }
}
