...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioCompensacaoAusenciaConsulta : IRepositorioBase<CompensacaoAusencia>
    {
        ...
        Task<CompensacaoAusencia> ObterPorAnoTurmaENome(int anoLetivo, long turmaId, string nome, long idIgnorar, string disciplinaId);
        ...
        Task<IEnumerable<long>> ObterPorIds(long[] compensacaoAusenciaIds);
    }
}
