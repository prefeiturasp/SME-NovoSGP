...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioConselhoClasseNotaConsulta : IRepositorioBase<ConselhoClasseNota>
    {
        ...
        Task<IEnumerable<NotaConceitoBimestreComponenteDto>> ObterNotasConceitosFechamentoPorTurmaCodigoEBimestreAsync(string turmaCodigo, string codigoAluno = null, int bimestre = 0, DateTime? dataMatricula = null, DateTime? dataSituacao = null);
        Task<IEnumerable<NotaConceitoBimestreComponenteDto>> ObterNotasConceitosConselhoClassePorTurmaCodigoEBimestreAsync(string turmaCodigo, int? bimestre,DateTime? dataMatricula = null, DateTime? dataSituacao = null);
