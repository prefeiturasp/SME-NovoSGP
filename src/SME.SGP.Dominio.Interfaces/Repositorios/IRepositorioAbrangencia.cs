...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioAbrangencia
    {
        ...
        Task<IEnumerable<AbrangenciaDreRetorno>> ObterDres(string login, Guid perfil, Modalidade? modalidade = null, int periodo = 0, bool consideraHistorico = false, int anoLetivo = 0, string filtroDescricao = "", string friltroCodigo = "");
