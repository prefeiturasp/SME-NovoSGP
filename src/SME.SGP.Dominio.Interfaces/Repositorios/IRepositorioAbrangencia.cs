...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioAbrangencia
    {
        ...
        Task<IEnumerable<DropdownTurmaRetornoDto>> ObterTurmasPorAnoLetivoUeModalidadeSemestreEAnosEscolares(int anoLetivo, string codigoUe, int[] modalidades, int semestre, string[] anos);
    }
}