...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioTurma
    {
        ...
        Task<PaginacaoResultadoDto<TurmaAcompanhamentoFechamentoRetornoDto>> ObterTurmasFechamentoAcompanhamento(Paginacao paginacao, long dreId, long ueId, long[] turmaId, Modalidade modalidade, int semestre, int bimestre, int anoLetivo);
