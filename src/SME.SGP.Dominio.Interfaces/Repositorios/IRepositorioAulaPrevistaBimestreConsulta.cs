...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioAulaPrevistaBimestreConsulta : IRepositorioBase<AulaPrevistaBimestre>
    {
        ...
        Task<IEnumerable<AulaPrevistaBimestre>> ObterAulasPrevistasPorTurmaTipoCalendarioDisciplina(long tipoCalendarioId, string turmaId, string[] disciplinasId, int? bimestre);
