...
namespace SME.SGP.Dominio.Interfaces.Repositorios
{
    public interface IRepositorioNovoEncaminhamentoNAAPA : IRepositorioBase<EncaminhamentoEscolar>
    {
        ...
        Task<IEnumerable<NovoEncaminhamentoNAAPACodigoArquivoDto>> ObterCodigoArquivoPorEncaminhamentoNAAPAId(long encaminhamentoId);
        Task<bool> ExisteEncaminhamentoNAAPAAtivoId(long encaminhamentoId);
    }
}