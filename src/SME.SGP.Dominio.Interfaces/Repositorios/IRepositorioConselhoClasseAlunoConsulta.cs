...
namespace SME.SGP.Dominio.Interfaces
{
    public interface IRepositorioConselhoClasseAlunoConsulta : IRepositorioBase<ConselhoClasseAluno>
    {
        ...
        Task<IEnumerable<NotaConceitoFechamentoConselhoFinalDto>> ObterNotasFinaisAlunoAsync(string[] turmasCodigos, string alunoCodigo, bool validaNota = false, bool validaConceito = false);
