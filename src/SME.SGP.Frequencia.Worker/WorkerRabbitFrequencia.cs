...
namespace SME.SGP.Frequencia.Worker
{
    public class WorkerRabbitFrequencia : WorkerRabbitMQBase
    {
        ...
        protected override void RegistrarUseCasesDoWorker()
        {
            ...
            Comandos.Add(RotasRabbitSgpFrequencia.RotaFrequenciaLancamentoAulaSgaSync, new ComandoRabbit("Tratar lançamento de frequências provenientes da integração SGA", typeof(ILancarFrequenciaAulaSgaUseCase)));
        }
    }
}
