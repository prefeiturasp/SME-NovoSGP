...
namespace SME.SGP.Pendencias.Worker
{
    public class WorkerRabbitPendencias : WorkerRabbitMQBase
    {
        ...
        protected override void RegistrarUseCasesDoWorker()
        {
            ...
            Comandos.Add(RotasRabbitSgpPendencias.RotaBuscarAdicionarQuantidadeAulaDiaPendencia, new ComandoRabbit("Obter de Quantidade de Aulas e Quantidade de Dias para atualizar a tabela de pendência", typeof(IObterQuantidadeAulaDiaPendenciaUseCase)));
