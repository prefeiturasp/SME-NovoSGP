...
namespace SME.SGP.Pendencias.Worker
{
    public class WorkerRabbitPendencias : WorkerRabbitAplicacao
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbitSgpPendencias.RotaExcluirPendenciaCalendarioAnoAnteriorCalendarioUes, new ComandoRabbit("Buscar por UE Pendências Calendário do Ano Anterior para excluir", typeof(IExcluirPendenciaCalendarioAnoAnteriorCalendarioBuscarPorUeUseCase)));
