...
namespace SME.SGP.Pendencias.Worker
{
    public class WorkerRabbitPendencias : WorkerRabbitMQBase
    {
        ...
        protected override void RegistrarUseCasesDoWorker()
        {
            ...
            Comandos.Add(RotasRabbitSgpPendencias.RotaBuscarAdicionarQuantidadeAulaDiaPendencia, new ComandoRabbit("Obter UEs para atualizar a tabela de pendência", typeof(IObterQuantidadeAulaDiaPendenciaUseCase)));
            Comandos.Add(RotasRabbitSgpPendencias.RotaBuscarAdicionarQuantidadeAulaDiaPendenciaUe, new ComandoRabbit("Obter Por UE a Quantidade de Aulas e Quantidade de Dias para atualizar a tabela de pendência", typeof(IObterQuantidadeAulaDiaPendenciaUseUeCase)));
