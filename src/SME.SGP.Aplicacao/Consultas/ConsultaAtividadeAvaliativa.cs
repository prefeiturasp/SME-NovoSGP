    ...
    public class ConsultaAtividadeAvaliativa : ConsultasBase, IConsultaAtividadeAvaliativa
    {
        ...
        public async Task<(IEnumerable<AtividadeAvaliativa>, int quantidadeBimestres, int bimestreAtual, PeriodoEscolar periodoAtual)> ObterAvaliacoesEBimestres(string turmaCodigo, string disciplinaId, int anoLetivo, int? bimestre, ModalidadeTipoCalendario modalidadeTipoCalendario)
        {
            ...
            if (!bimestre.HasValue || bimestre.Value == 0)
                bimestre = ObterBimestreAtual(modalidadeTipoCalendario, tipoCalendario, periodosEscolares);
        ...
        private int? ObterBimestreAtual(ModalidadeTipoCalendario modalidadeTipoCalendario, TipoCalendario tipoCalendario, IEnumerable<PeriodoEscolar> periodosEscolares)
        {
            ...
            if (periodoEscolar == null)
                throw new NegocioException("Não foi possível obter o bimestre atual");
