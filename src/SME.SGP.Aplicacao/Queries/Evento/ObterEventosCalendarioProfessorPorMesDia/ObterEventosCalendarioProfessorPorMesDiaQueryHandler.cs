...
namespace SME.SGP.Aplicacao
{
    public class ObterEventosCalendarioProfessorPorMesDiaQueryHandler : IRequestHandler<ObterEventosCalendarioProfessorPorMesDiaQuery, IEnumerable<Evento>>
    {
        ...
        {
            return await repositorioEvento.ObterEventosCalendarioProfessorPorMesDia(request.DreCodigo, request.UeCodigo, request.DataConsulta, request.TipoCalendarioId, true);
        }
    }
}
