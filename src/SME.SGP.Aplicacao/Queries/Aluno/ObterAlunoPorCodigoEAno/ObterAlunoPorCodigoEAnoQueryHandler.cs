...
namespace SME.SGP.Aplicacao
{
    ...
    {        
        ...
        {
            var alunoPorTurmaResposta = (await mediator.Send(new ObterTurmasAlunoPorFiltroQuery(request.CodigoAluno, request.AnoLetivo, false, request.TurmaHistorica, request.TipoTurma))).OrderByDescending(a => a.DataSituacao)?.FirstOrDefault();
