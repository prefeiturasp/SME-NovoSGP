...
namespace SME.SGP.Aplicacao
{
    public class ObterInstrucoesModalQueryHandler : IRequestHandler<ObterInstrucoesModalQuery, string>
    {
        ...
        {
            var instruoesModal = @"<b>O preenchimento deste encaminhamento é exclusivo para o público da Educação Especial. 
                                   Segundo as normativas do município, o Atendimento Educação Especializado (AEE) é um 
                                   serviço a ser ofertado exclusivamente para Estudantes/Crianças nos seguintes casos:</b> <br/>
