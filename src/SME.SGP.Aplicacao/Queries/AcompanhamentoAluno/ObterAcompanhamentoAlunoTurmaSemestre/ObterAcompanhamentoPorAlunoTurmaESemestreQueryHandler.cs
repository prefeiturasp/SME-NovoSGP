...
{
    public class ObterAcompanhamentoPorAlunoTurmaESemestreQueryHandler : IRequestHandler<ObterAcompanhamentoPorAlunoTurmaESemestreQuery, IEnumerable<AcompanhamentoAlunoDto>>
    {
        ...
        public async Task<IEnumerable<AcompanhamentoAlunoDto>> Handle(ObterAcompanhamentoPorAlunoTurmaESemestreQuery request, CancellationToken cancellationToken)
