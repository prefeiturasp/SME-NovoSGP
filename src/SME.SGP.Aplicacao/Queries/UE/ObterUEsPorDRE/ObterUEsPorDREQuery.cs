...
namespace SME.SGP.Aplicacao
{
    ...
    {
        public ObterUEsPorDREQuery(string codigoDre, string login, Guid perfil, Modalidade? modalidade, int periodo = 0, bool consideraHistorico = false, int anoLetivo = 0, bool consideraNovasUEs = false)
        {
            CodigoDre = codigoDre;
            Login = login;
            Perfil = perfil;
