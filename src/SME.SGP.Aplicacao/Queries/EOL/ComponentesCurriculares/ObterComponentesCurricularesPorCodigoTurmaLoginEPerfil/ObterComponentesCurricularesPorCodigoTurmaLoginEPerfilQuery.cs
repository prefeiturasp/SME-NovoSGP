...
namespace SME.SGP.Aplicacao
{
    ...
    {
        public ObterComponentesCurricularesPorCodigoTurmaLoginEPerfilQuery(string codigoTurma, string login, Guid perfil, bool realizarAgrupamentoComponente = false, bool checaMotivoDisponibilizacao = true)
        {
