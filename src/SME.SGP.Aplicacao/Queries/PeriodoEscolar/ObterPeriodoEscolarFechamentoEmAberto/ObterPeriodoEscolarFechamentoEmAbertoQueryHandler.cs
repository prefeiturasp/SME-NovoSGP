...
{
    public class ObterPeriodoEscolarFechamentoEmAbertoQueryHandler : IRequestHandler<ObterPeriodoEscolarFechamentoEmAbertoQuery, PeriodoEscolar>
    {
        ...
        public Task<PeriodoEscolar> Handle(ObterPeriodoEscolarFechamentoEmAbertoQuery request, CancellationToken cancellationToken)
