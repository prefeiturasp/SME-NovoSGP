        ...
        public async Task<IEnumerable<AEEAcessibilidadeRetornoDto>> Handle(ObterPlanosAEEAcessibilidadesQuery request, CancellationToken cancellationToken)
        {
            ...
            if(query.Any())
            {
                ...
                retorno.Add(new AEEAcessibilidadeRetornoDto()
                {
                    ...
                    QuantidadeSim = dadosRegular.FirstOrDefault(a => a.Opcao.ToUpper() == "SIM").Quantidade,
                    QuantidadeNao = dadosRegular.FirstOrDefault(a => a.Opcao.ToUpper() == "NÃO").Quantidade,
                    LegendaSim = "Sim",
                    LegendaNao = "Não",
                });
                ...
                retorno.Add(new AEEAcessibilidadeRetornoDto()
                {
                    ...
                    QuantidadeSim = dadosSRM.FirstOrDefault(a => a.Opcao.ToUpper() == "SIM").Quantidade,
                    QuantidadeNao = dadosSRM.FirstOrDefault(a => a.Opcao.ToUpper() == "NÃO").Quantidade,
                    LegendaSim = "Sim",
                    LegendaNao = "Não",
                });
