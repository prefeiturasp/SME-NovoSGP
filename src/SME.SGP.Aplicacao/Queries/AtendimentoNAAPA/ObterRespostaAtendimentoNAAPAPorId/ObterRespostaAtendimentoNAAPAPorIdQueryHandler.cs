...
namespace SME.SGP.Aplicacao
{
    public class ObterRespostaAtendimentoNAAPAPorIdQueryHandler : ConsultasBase, IRequestHandler<ObterRespostaAtendimentoNAAPAPorIdQuery, RespostaEncaminhamentoNAAPA>
    {
        ...
        public ObterRespostaAtendimentoNAAPAPorIdQueryHandler(IContextoAplicacao contextoAplicacao, IRepositorioRespostaEncaminhamentoNAAPA repositorioEncaminhamentoNAAPA) : base(contextoAplicacao)
        {
