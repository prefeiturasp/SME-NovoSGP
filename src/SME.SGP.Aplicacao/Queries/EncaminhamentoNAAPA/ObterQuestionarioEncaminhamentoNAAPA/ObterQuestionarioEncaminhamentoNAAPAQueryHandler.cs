...
{
    public class ObterQuestionarioEncaminhamentoNAAPAQueryHandler : IRequestHandler<ObterQuestionarioEncaminhamentoNAAPAQuery, IEnumerable<QuestaoDto>>
    {
        private readonly IMediator mediator;
        private readonly IRepositorioQuestaoEncaminhamentoNAAPA repositorioQuestaoEncaminhamento;

        public ObterQuestionarioEncaminhamentoNAAPAQueryHandler(IMediator mediator, IRepositorioQuestaoEncaminhamentoNAAPA repositorioQuestaoEncaminhamento, IRepositorioQuestionario repositorioQuestionario)
        {
        ...
        public async Task<IEnumerable<QuestaoDto>> Handle(ObterQuestionarioEncaminhamentoNAAPAQuery request, CancellationToken cancellationToken)
        {
