...
{
    public class ObterObservacaoEncaminhamentosNAAPAQueryHandler : ConsultasBase, IRequestHandler<ObterObservacaoEncaminhamentosNAAPAQuery, PaginacaoResultadoDto<EncaminhamentoNAAPAObservacoesDto>>
    {
