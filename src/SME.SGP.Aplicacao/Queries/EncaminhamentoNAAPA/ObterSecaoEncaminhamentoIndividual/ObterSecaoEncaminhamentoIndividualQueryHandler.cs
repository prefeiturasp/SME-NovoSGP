...
namespace SME.SGP.Aplicacao.Queries.EncaminhamentoNAAPA.ObterSecaoEncaminhamentoIndividual
{
       ...
       public class ObterSecaoEncaminhamentoIndividualQueryHandler : IRequestHandler<ObterSecaoEncaminhamentoIndividualQuery, IEnumerable<SecaoQuestionarioDto>>
    {
        private readonly IRepositorioSecaoEncaminhamentoNAAPA repositorioSecaoEncaminhamentoNAPPA;

        public ObterSecaoEncaminhamentoIndividualQueryHandler(IRepositorioSecaoEncaminhamentoNAAPA repositorioSecaoEncaminhamentoNAPPA)
        {
        ...
        public async Task<IEnumerable<SecaoQuestionarioDto>> Handle(ObterSecaoEncaminhamentoIndividualQuery request, CancellationToken cancellationToken)
        {
