    ...
    public class ObterDescricoesRegistrosIndividuaisPorPeriodoQueryValidator : AbstractValidator<ObterDescricoesRegistrosIndividuaisPorPeriodoQuery>
    {
        public ObterDescricoesRegistrosIndividuaisPorPeriodoQueryValidator()
        {
            ...
            RuleFor(a => a.DataInicio)
                .NotEmpty()
                .WithMessage("A Data de Início deve ser informada para consulta de Registros Individuáis do Estudante");

            RuleFor(a => a.DataFim)
                .NotEmpty()
                .WithMessage("A Data de Fim deve ser informada para consulta de Registros Individuáis do Estudante");
        }
    }
}
