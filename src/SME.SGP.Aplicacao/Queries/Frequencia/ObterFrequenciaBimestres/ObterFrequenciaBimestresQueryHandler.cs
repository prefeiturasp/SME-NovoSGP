...
namespace SME.SGP.Aplicacao
{
    public class ObterFrequenciaBimestresQueryHandler : IRequestHandler<ObterFrequenciaBimestresQuery, IEnumerable<FrequenciaBimestreAlunoDto>>
    {
        ...
        {
            var frequenciaAluno = await repositorioFrequenciaAlunoDisciplinaPeriodo.ObterFrequenciaBimestresAsync(request.CodigoAluno.ToString(),0 ,request.CodigoTurma, TipoFrequenciaAluno.Geral);
