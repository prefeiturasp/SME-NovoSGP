...
namespace SME.SGP.Aplicacao
{
    public class ObterPlanoAulaUseCase : AbstractUseCase, IObterPlanoAulaUseCase
    {
        ...
        public async Task<PlanoAulaRetornoDto> Executar(FiltroObterPlanoAulaDto filtro)
        {
            ...
            {
                var disciplinasRetorno = await mediator.Send(new ObterComponentesCurricularesPorIdsEUsuariosQuery(new long[] { filtro.ComponenteCurricularId.Value }, codigoTurma: aulaDto.TurmaId));
