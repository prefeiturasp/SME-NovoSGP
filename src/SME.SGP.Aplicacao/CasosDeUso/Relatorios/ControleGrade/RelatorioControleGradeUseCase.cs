...
namespace SME.SGP.Aplicacao
{
    public class RelatorioControleGradeUseCase : AbstractUseCase, IRelatorioControleGradeUseCase
    {
        ...
        public async Task<bool> Executar(FiltroRelatorioControleGrade filtro)
        {
            ...
            return await mediator.Send(new GerarRelatorioCommand(TipoRelatorio.ControleGrade, filtro, usuarioLogado,rotaRelatorio: RotasRabbitSgpRelatorios.RotaRelatoriosSolicitadosRegistroIndividual));
        }
    }
}
