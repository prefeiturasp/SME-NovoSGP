...
namespace SME.SGP.Aplicacao
{
    public class RelatorioBuscasAtivasUseCase : IRelatorioBuscasAtivasUseCase
    {
        ...
        public async Task<bool> Executar(FiltroRelatorioBuscasAtivasDto param)
        {
            ...
            return await mediator.Send(new GerarRelatorioCommand(TipoRelatorio.RelatorioBuscasAtivas, param, usuarioLogado, rotaRelatorio: RotasRabbitSgpRelatorios.RotaRelatoriosSolicitadosBuscaAtiva));
        }
    }
}
