...
namespace SME.SGP.Aplicacao
{
    public class CriarAulasInfantilAutomaticamenteUseCase : ICriarAulasInfantilAutomaticamenteUseCase
    {
        ...
        public async Task<bool> Executar(MensagemRabbit mensagemRabbit)
        {
            ...
            var tiposCalendarioIds = await mediator.Send(new ObterTiposCalendariosAulaAutomaticaPorAnoLetivoEModalidadesQuery(anoAtual, modalidades));
            foreach (var tipoCalendarioId in tiposCalendarioIds)
            {
