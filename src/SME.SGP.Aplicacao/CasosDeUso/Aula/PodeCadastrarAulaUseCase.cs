...
namespace SME.SGP.Aplicacao
{
    public class PodeCadastrarAulaUseCase : AbstractUseCase, IPodeCadastrarAulaUseCase
    {
        ...
        public async Task<CadastroAulaDto> Executar(FiltroPodeCadastrarAulaDto filtro)
        {
            ...
            {                
                if (!await mediator.Send(new PodeCadastrarAulaNoDiaQuery(filtro.DataAula, filtro.TurmaCodigo, filtro.ComponentesCurriculares, filtro.TipoAula,usuarioLogado.CodigoRf)))
