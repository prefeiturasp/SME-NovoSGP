...
namespace SME.SGP.Aplicacao
{
    public class SalvarAnotacaoFrequenciaAlunoUseCase : ISalvarAnotacaoFrequenciaAlunoUseCase
    {
        ...
        public async Task<AuditoriaDto> Executar(SalvarAnotacaoFrequenciaAlunoDto dto)
        {
            ...
            var tipoTurma = !turma.EhTurmaPrograma();
            ...
            var aluno = await mediator.Send(new ObterAlunoPorCodigoEolQuery(dto.CodigoAluno, aula.DataAula.Year, codigoTurma: aula.TurmaId,tipoTurma:tipoTurma));
            if (aluno == null)
