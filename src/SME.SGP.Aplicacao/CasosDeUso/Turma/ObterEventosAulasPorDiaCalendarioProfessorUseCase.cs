...
{
    public class ObterEventosAulasPorDiaCalendarioProfessorUseCase
    {
        public static async Task<int[]> Executar(IMediator mediator, FiltroAulasEventosCalendarioDto filtroAulasEventosCalendarioDto, long tipoCalendarioId, int mes, int dia)
        {
