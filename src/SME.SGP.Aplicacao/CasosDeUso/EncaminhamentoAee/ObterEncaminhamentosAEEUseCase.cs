...
namespace SME.SGP.Aplicacao
{
    public class ObterEncaminhamentosAEEUseCase : AbstractUseCase, IObterEncaminhamentosAEEUseCase
    {
        ...
        {
            return await mediator.Send(new ObterEncaminhamentosAEEQuery(filtros.DreId, filtros.UeId, filtros.TurmaId, filtros.AlunoCodigo, filtros.Situacao, filtros.ResponsavelRf));
        }
    }
}
