...
{
    public class ExcluirArquivoInformeUseCase : AbstractUseCase, IExcluirArquivoInformeUseCase
    {
        public ExcluirArquivoInformeUseCase(IMediator mediator) : base(mediator)
        {
        }
