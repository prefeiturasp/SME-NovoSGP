...
{
    public class NotificarSobreTransferenciaUeDreAlunoTurmaDoEncaminhamentoNAAPAUseCase : AbstractUseCase, INotificarSobreTransferenciaUeDreAlunoTurmaDoAtendimentoNAAPAUseCase
    {
