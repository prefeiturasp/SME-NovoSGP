...
{
    public class ExecutarInserirConsolidadoAtendimentoProfissionalEncaminhamentoNAAPAUseCase : AbstractUseCase, IExecutarInserirConsolidadoAtendimentoProfissionalAtendimentoNAAPAUseCase
