...
namespace SME.SGP.Aplicacao.CasosDeUso.PainelEducacional
{
    public class ConsultasRegistroFrequenciaAgrupamentoGlobalUseCase : IConsultasRegistroFrequenciaAgrupamentoGlobalUseCase
    {
        ...
        public async Task<IEnumerable<PainelEducacionalRegistroFrequenciaAgrupamentoGlobalDto>> ObterFrequencia(int anoLetivo, string codigoDre, string codigoUe)
        {
            return await mediator.Send(new PainelEducacionalRegistroFrequenciaAgrupamentoGlobalQuery(anoLetivo, codigoDre, codigoUe));
        }
    }
}
