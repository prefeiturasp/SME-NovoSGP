...
namespace SME.SGP.Aplicacao.CasosDeUso.PainelEducacional
{
    public class ConsolidarInformacoesPapPainelEducacionalUseCase : AbstractUseCase, IConsolidarInformacoesPapPainelEducacionalUseCase
    {
        ...
        private async Task<int> DeterminarAnoInicioConsolidacao()
        {
            ...
            // Se a consolidação do ano corrente já foi feita, reprocessa apenas o ano corrente.
                ...
                IList<PainelEducacionalConsolidacaoPapUe> Ue)> ObterDadosConsolidadosPorVisao(int anoLetivo)
        {
            ...
            // FASE 4: MONTAR LISTAS FINAIS COMBINANDO OS DADOS
        ...
        private PainelEducacionalConsolidacaoPapSme 
        ...
        private PainelEducacionalConsolidacaoPapDre 
        ...
        private PainelEducacionalConsolidacaoPapUe 
        ...
        private void MapearDadosBase(PainelEducacionalConsolidacaoPapBase consolidado, ChaveAgregacao chave, DadosAgregadosTurma turma, DadosAgregadosDificuldade dif)
        {
