...
{
    public class ExecutarSincronizacaoDevolutivasPorTurmaInfantilTratarUseCase : AbstractUseCase, IExecutarSincronizacaoDevolutivasPorTurmaInfantilTratarUseCase
    {
        public ExecutarSincronizacaoDevolutivasPorTurmaInfantilTratarUseCase(IMediator mediator) : base(mediator)
        {
        }
