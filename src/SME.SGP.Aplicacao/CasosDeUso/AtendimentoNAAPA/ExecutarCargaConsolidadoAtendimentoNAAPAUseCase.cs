...
{
    public class ExecutarCargaConsolidadoAtendimentoNAAPAUseCase : AbstractUseCase, IExecutarCargaConsolidadoAtendimentoNAAPAUseCase
    {
        public ExecutarCargaConsolidadoAtendimentoNAAPAUseCase(IMediator mediator) : base(mediator)
        {
        }
