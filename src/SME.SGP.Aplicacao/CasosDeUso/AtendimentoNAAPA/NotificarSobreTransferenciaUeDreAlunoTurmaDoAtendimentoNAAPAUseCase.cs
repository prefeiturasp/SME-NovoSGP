...
{
    public class NotificarSobreTransferenciaUeDreAlunoTurmaDoAtendimentoNAAPAUseCase : AbstractUseCase, INotificarSobreTransferenciaUeDreAlunoTurmaDoAtendimentoNAAPAUseCase
    {
        public NotificarSobreTransferenciaUeDreAlunoTurmaDoAtendimentoNAAPAUseCase(IMediator mediator) : base(mediator)
        {
        }
