...
{
    public class AtualizarTurmaDoAtendimentoNAAPAUseCase : AbstractUseCase, IAtualizarTurmaDoAtendimentoNAAPAUseCase
    {
        public AtualizarTurmaDoAtendimentoNAAPAUseCase(IMediator mediator) : base(mediator)
        {
        }
        ...
        {
            var encaminhamentoNAAPA = await mediator.Send(new ObterAtendimentoNAAPAComTurmaPorIdQuery(encaminhamentoNAAPAId));
