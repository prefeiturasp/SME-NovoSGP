...
{
    public class ExecutarBuscarConsolidadoAtendimentosProfissionalAtendimentoNAAPAUseCase : AbstractUseCase, IExecutarBuscarConsolidadoAtendimentosProfissionalAtendimentoNAAPAUseCase
    {
        public ExecutarBuscarConsolidadoAtendimentosProfissionalAtendimentoNAAPAUseCase(IMediator mediator) : base(mediator)
        {
        }
        ...
        public async Task<bool> Executar(MensagemRabbit param)
        {
            ...
            var atendimentosProfissional = await mediator.Send(new ObterAtendimentosProfissionalAtendimentosNAAPAConsolidadoCargaQuery(filtro.UeId, filtro.Mes, filtro.AnoLetivo));
