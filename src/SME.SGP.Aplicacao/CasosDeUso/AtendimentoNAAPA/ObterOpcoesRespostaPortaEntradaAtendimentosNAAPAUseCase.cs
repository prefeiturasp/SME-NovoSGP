...
{
    public class ObterOpcoesRespostaPortaEntradaAtendimentosNAAPAUseCase : IObterOpcoesRespostaPortaEntradaAtendimentosNAAPAUseCase
    {
        private readonly IMediator mediator;
        private const string NOME_COMPONENTE_QUESTAO_PORTA_ENTRADA = "PORTA_ENTRADA";

        public ObterOpcoesRespostaPortaEntradaAtendimentosNAAPAUseCase(IMediator mediator)
        {
