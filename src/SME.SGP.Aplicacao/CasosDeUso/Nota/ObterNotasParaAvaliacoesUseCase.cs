...
namespace SME.SGP.Aplicacao
{
    public class ObterNotasParaAvaliacoesUseCase : IObterNotasParaAvaliacoesUseCase
    {
        ...
        public async Task<NotasConceitosRetornoDto> Executar(ListaNotasConceitosDto filtro)
        {
            ...
            var componentesCurricularesCompletos = await mediator.Send(new ObterComponentesCurricularesPorIdsEUsuariosQuery(new long[] { filtro.DisciplinaCodigo }, codigoTurma: turmaCompleta.CodigoTurma));
