...
{
    public class ExecutaConsolidacaoMensalDashBoardFrequenciaUseCase : AbstractUseCase, IExecutaConsolidacaoMensalDashBoardFrequenciaUseCase
    {
        public ExecutaConsolidacaoMensalDashBoardFrequenciaUseCase(IMediator mediator) : base(mediator)
        {
        }
