...
{
    public class ExecutarNotificacaoAlunosFreqMensalInsuficienteBuscaAtivaUseCase : AbstractUseCase, IExecutarNotificacaoAlunosFreqMensalInsuficienteBuscaAtivaUseCase
    {
        public ExecutarNotificacaoAlunosFreqMensalInsuficienteBuscaAtivaUseCase(IMediator mediator) : base(mediator)
        {
        }
