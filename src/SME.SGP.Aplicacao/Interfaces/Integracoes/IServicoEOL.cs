...
namespace SME.SGP.Aplicacao.Integracoes
{
    public interface IServicoEol
    {
        ...
        Task<IEnumerable<AlunoPorTurmaResposta>> ObterAlunosPorNomeCodigoEol(string anoLetivo, string codigoUe, long codigoTurma, string nome, string codigoEol);
        ...
        Task<InformacoesEscolaresAlunoDto> ObterNecessidadesEspeciaisAluno(long codigoAluno);
    }
}