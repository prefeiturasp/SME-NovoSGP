...
namespace SME.SGP.Aplicacao.Integracoes
{
    public interface IServicoEol
    {
        ...
        Task<IEnumerable<CicloRetornoDto>> BuscarCiclos();

        Task<IEnumerable<TipoEscolaRetornoDto>> BuscarTiposEscola();
        ...
        Task<IEnumerable<DreRespostaEolDto>> ObterDres();

        Task<IEnumerable<EscolasRetornoDto>> ObterEscolasPorCodigo(string[] codigoUes);

        Task<IEnumerable<EscolasRetornoDto>> ObterEscolasPorDre(string dreId);

        Task<EstruturaInstitucionalRetornoEolDTO> ObterEstruturaInstuticionalVigentePorDre();

        Task<EstruturaInstitucionalRetornoEolDTO> ObterEstruturaInstuticionalVigentePorTurma(string[] codigosTurma = null);
        ...
        Task<IEnumerable<ProfessorTurmaReposta>> ObterListaTurmasPorProfessor(string codigoRf);
        ...
        Task<IEnumerable<SupervisoresRetornoDto>> ObterSupervisoresPorCodigo(string[] codigoSupervisores);
