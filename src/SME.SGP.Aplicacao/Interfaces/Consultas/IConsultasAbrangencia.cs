...
namespace SME.SGP.Aplicacao
{
    public interface IConsultasAbrangencia
    {
        ...
        Task<IEnumerable<AbrangenciaTurmaRetorno>> ObterTurmasPorTipos(string codigoUe, Modalidade modalidade, int periodo, bool consideraHistorico, int anoLetivo, int[] tipos);
    }
}