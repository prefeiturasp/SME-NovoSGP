...
namespace SME.SGP.Aplicacao
{
    public interface IConsultaRecuperacaoParalela
    {
        ...
        Task<IEnumerable<RecuperacaoParalelaTotalResultadoDto>> ListarTotalResultadoEncaminhamento(int? periodo, string dreId, string ueId, int? cicloId, string turmaId, int? ano, int? numeroPagina);
