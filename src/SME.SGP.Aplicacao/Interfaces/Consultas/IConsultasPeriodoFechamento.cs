...
namespace SME.SGP.Aplicacao
{
    public interface IConsultasPeriodoFechamento
    {
        ...
        Task<bool> TurmaEmPeriodoDeFechamento(Turma turma, TipoCalendario tipoCalendario, DateTime dataReferencia, int bimestre = 0, int bimestreAlteracao = 0);
        Task<IEnumerable<PeriodoEscolarDto>> ObterPeriodosEmAberto(long ueId);
        Task<bool> TurmaEmPeriodoDeFechamento(Turma turma, DateTime dataReferencia, int bimestre = 0, int bimestreAlteracao = 0);
