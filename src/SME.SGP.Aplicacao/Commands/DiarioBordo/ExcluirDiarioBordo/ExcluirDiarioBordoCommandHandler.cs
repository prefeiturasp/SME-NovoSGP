...
namespace SME.SGP.Aplicacao
{
    public class ExcluirDiarioBordoCommandHandler : IRequestHandler<ExcluirDiarioBordoCommand, bool>
    {
        ...
        public ExcluirDiarioBordoCommandHandler(IRepositorioDiarioBordo repositorioDiarioBordo, IRepositorioDiarioBordoObservacao repositorioDiarioBordoObservacao, IMediator mediator)
        {
