...
namespace SME.SGP.Aplicacao
{
    public class GerarPendenciaAtribuirResponsavelEncaminhamentoAEECommandHandler : IRequestHandler<GerarPendenciaAtribuirResponsavelEncaminhamentoAEECommand, bool>
    {
        ...
        private async Task<bool> EnviarParaFuncionarios(Turma turma, EncaminhamentoAEE encaminhamentoAEE)
        {
            ...
            var descricao = $"O encaminhamento {estudanteOuCrianca} {encaminhamentoAEE.AlunoNome} ({encaminhamentoAEE.AlunoCodigo}) da turma {ueDre} está disponível para atribuição de um PAEE. <br/><a href='{hostAplicacao}relatorios/aee/encaminhamento/editar/{encaminhamentoAEE.Id}'>Clique aqui para acessar o encaminhamento.</a> " +
