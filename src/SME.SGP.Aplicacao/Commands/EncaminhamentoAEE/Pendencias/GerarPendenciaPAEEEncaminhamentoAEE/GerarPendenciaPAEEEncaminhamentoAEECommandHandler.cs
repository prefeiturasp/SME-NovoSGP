...
namespace SME.SGP.Aplicacao
{
    public class GerarPendenciaPAEEEncaminhamentoAEECommandHandler : IRequestHandler<GerarPendenciaPAEEEncaminhamentoAEECommand, bool>
    {
        ...
        public async Task<bool> Handle(GerarPendenciaPAEEEncaminhamentoAEECommand request, CancellationToken cancellationToken)
        {
            ...
            var descricao = $"O encaminhamento {estudanteOuCrianca} {encaminhamentoAEE.AlunoNome} ({encaminhamentoAEE.AlunoCodigo}) da turma {ueDre} está disponível para análise. <br/><a href='{hostAplicacao}relatorios/aee/encaminhamento/editar/{encaminhamentoAEE.Id}'>Clique aqui para acessar o encaminhamento.</a> " +
