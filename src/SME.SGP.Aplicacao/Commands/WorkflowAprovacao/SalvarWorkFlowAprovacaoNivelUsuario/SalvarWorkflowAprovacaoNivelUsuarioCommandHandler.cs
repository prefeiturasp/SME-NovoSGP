...
{
    public class SalvarWorkflowAprovacaoNivelUsuarioCommandHandler : IRequestHandler<SalvarWorkflowAprovacaoNivelUsuarioCommand, long>
    {
        ...
        public SalvarWorkflowAprovacaoNivelUsuarioCommandHandler(IMediator mediator,
        ...
        public async Task<long> Handle(SalvarWorkflowAprovacaoNivelUsuarioCommand request, CancellationToken cancellationToken)
        {
