...
{
    public class SalvarConselhoClasseNotaCommandHandler : IRequestHandler<SalvarConselhoClasseNotaCommand>
    {
        ...
        public async Task Handle(SalvarConselhoClasseNotaCommand request, CancellationToken cancellationToken)
        {
