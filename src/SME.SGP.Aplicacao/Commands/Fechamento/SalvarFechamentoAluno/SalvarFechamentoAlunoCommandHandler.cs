...
{
    public class SalvarFechamentoAlunoCommandHandler : IRequestHandler<SalvarFechamentoAlunoCommand>
    {
        ...
        public Task Handle(SalvarFechamentoAlunoCommand request, CancellationToken cancellationToken)
