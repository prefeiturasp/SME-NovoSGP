...
public class InserirOuAtualizarCacheFechamentoNotaConceitoCommandHandler : IRequestHandler<InserirOuAtualizarCacheFechamentoNotaConceitoCommand, bool>
{
    ...
    public async Task<bool> Handle(InserirOuAtualizarCacheFechamentoNotaConceitoCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            var cacheAluno = retornoCacheMapeado.FirstOrDefault(c => c.AlunoCodigo == fechamentoNotaConceito.CodigoAluno && 
