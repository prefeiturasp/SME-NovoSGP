...
{
    public class ImportarAvisoDoMuralGsaCommandHandler : IRequestHandler<ImportarAvisoDoMuralGsaCommand>
    {
        ...
        public async Task Handle(ImportarAvisoDoMuralGsaCommand request, CancellationToken cancellationToken)
        {
