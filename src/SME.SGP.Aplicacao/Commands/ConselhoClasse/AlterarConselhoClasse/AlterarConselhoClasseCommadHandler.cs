...
namespace SME.SGP.Aplicacao
{
    public class AlterarConselhoClasseCommadHandler : InserirAlterarConselhoClasseAbstrato, IRequestHandler<AlterarConselhoClasseCommad, ConselhoClasseNotaRetornoDto>
    {
        ...
        public async Task<ConselhoClasseNotaRetornoDto> Handle(AlterarConselhoClasseCommad request, CancellationToken cancellationToken)
        {
            ...
            await RemoverCache(string.Format(NomeChaveCache.CHAVE_NOTA_CONCEITO_FECHAMENTO_TURMA_ALUNO_BIMESTRES_E_FINAL, request.Turma.CodigoTurma, request.CodigoAluno), cancellationToken);
            await RemoverCache(string.Format(NomeChaveCache.CHAVE_NOTA_CONCEITO_CONSELHO_CLASSE_TURMA_BIMESTRE_ALUNO, request.Turma.CodigoTurma, request.Bimestre, request.CodigoAluno), cancellationToken);
