...
namespace SME.SGP.Aplicacao.Commands
{
    public class SalvarPlanoAEERespostaCommandHandler : IRequestHandler<SalvarPlanoAEERespostaCommand, long>
    {
        ...
        private async Task<PlanoAEEResposta> MapearParaEntidade(SalvarPlanoAEERespostaCommand request)
        {
            ...
            if (EnumExtension.EhUmDosValores(request.TipoQuestao, new Enum[] { TipoQuestao.Frase, TipoQuestao.Texto, TipoQuestao.AtendimentoClinico, TipoQuestao.FrequenciaEstudanteAEE, TipoQuestao.PeriodoEscolar,TipoQuestao.InformacoesSrm }))
            {
