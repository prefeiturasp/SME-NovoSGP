...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioFechamentoAlunoDuplicado(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
