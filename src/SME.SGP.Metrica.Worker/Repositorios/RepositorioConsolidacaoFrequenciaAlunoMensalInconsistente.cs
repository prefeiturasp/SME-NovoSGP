...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioConsolidacaoFrequenciaAlunoMensalInconsistente(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
