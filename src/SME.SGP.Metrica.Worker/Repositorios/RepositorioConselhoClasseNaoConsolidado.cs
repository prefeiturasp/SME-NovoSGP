...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioConselhoClasseNaoConsolidado(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
