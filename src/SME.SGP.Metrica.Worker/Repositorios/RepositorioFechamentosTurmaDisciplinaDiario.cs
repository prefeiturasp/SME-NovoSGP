...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioFechamentosTurmaDisciplinaDiario(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
