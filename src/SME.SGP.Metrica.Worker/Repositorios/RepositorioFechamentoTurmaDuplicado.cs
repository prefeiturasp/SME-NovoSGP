...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioFechamentoTurmaDuplicado(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
