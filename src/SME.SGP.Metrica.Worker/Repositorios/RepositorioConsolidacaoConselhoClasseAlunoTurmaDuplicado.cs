...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioConsolidacaoConselhoClasseAlunoTurmaDuplicado(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
