...
namespace SME.SGP.Metrica.Worker.Repositorios
{
    ...
    {
        public RepositorioConselhoClasseNotaDuplicado(ElasticsearchClient elasticClient, IServicoTelemetria servicoTelemetria, IOptions<ElasticOptions> elasticOptions) 
