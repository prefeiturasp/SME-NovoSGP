...
{
    public class RegistroFrequenciaAlunoDuplicadoUEUseCase : IRegistroFrequenciaAlunoDuplicadoUEUseCase
    {
        private readonly IRepositorioSGPConsulta repositorioSGP;
        private readonly IMediator mediator;

        public RegistroFrequenciaAlunoDuplicadoUEUseCase(IRepositorioSGPConsulta repositorioSGP,
                                                         IMediator mediator)
        {
