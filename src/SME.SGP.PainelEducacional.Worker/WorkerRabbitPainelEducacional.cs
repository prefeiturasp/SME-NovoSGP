...
namespace SME.SGP.PainelEducacional.Worker
{
    ...
    public class WorkerRabbitPainelEducacional : WorkerRabbitAplicacao
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbitSgpPainelEducacional.ConsolidarAprovacaoPainelEducacional, new ComandoRabbit("Consolidar Aprovacao para o Painel Educacional", typeof(IConsolidarProficienciaIdepPainelEducacionalUseCase)));
        }
    }
}
