...
namespace SME.SGP.PainelEducacional.Worker
{
    ...
    public class WorkerRabbitPainelEducacional : WorkerRabbitAplicacao
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbitSgpPainelEducacional.ConsolidarInformacoesPapPainelEducacional, new ComandoRabbit("Sincronização e Consolidação dos Dados dos Indicadores PAP", typeof(IConsolidarInformacoesPapPainelEducacionalUseCase)));
