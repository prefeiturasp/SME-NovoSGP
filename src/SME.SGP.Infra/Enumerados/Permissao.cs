namespace SME.SGP.Infra
{
    public enum Permissao
    {
        ...
        [PermissaoMenu(Menu = "Resumos e gráficos PAP", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 1, EhConsulta = true,  Url = "/relatorios/pap/resumos-e-graficos")]
        RGP_C = 120,

        [PermissaoMenu(Menu = "Acompanhamento PAP", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 2, EhConsulta = true, Url = "/relatorios/pap/acompanhamento")]
        RAP_C = 116,
