namespace SME.SGP.Infra
{
    public enum Permissao
    {
       ...
       Url = "/relatorios/pap/relatorio-preenchimento", EhSubMenu = true, OrdemSubMenu = 1, SubMenu = "Preenchimento")]
        ...
        [PermissaoMenu(Menu = "Documentos e planos de trabalho", Icone = "fas fa-file-alt", Agrupamento = "Gestão", OrdemAgrupamento = 7, OrdemMenu = 2, EhAlteracao = false, Url = "/gestao/documentos-planos-trabalho", EhSubMenu = true, OrdemSubMenu = 2)]
        DPU_C = 177,
