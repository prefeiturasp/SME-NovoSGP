namespace SME.SGP.Infra
{
    public enum Permissao
    {
        ...
        [PermissaoMenu(Menu = "Resumos e Gráficos", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 1, EhConsulta = true,  Url = "/recuperacao-paralela/resumos/")]
        RGP_C = 120,

        [PermissaoMenu(Menu = "Acompanhamento", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 2, EhConsulta = true, Url = "/relatorios/pap/acompanhamento")]
        RAP_C = 116,
    }
}