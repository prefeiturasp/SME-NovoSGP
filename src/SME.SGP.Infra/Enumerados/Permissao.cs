namespace SME.SGP.Infra
{
    public enum Permissao
    {
       ...
       Url = "/relatorios/pap/relatorio-preenchimento", EhSubMenu = true, OrdemSubMenu = 1, SubMenu = "Preenchimento")]
        ...
        [PermissaoMenu(Menu = "Dashboard Escola aqui", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 2, EhAlteracao = false, Url = "/relatorios/escola-aqui/dashboard", EhSubMenu = true, OrdemSubMenu = 5, SubMenu = "Escola Aqui")]
        RDE_A = 177
    }
}