namespace SME.SGP.Infra
{
    public enum Permissao
    {
       ...
       Url = "/relatorios/pap/relatorio-preenchimento", EhSubMenu = true, OrdemSubMenu = 1, SubMenu = "Preenchimento")]
        ...
        [PermissaoMenu(Menu = "Escola aqui", Icone = "fas fa-file-alt", Agrupamento = "Relatórios", OrdemAgrupamento = 7, OrdemMenu = 2, EhAlteracao = false, Url = "/relatorios/escola-aqui/dados-leitura", EhSubMenu = true, OrdemSubMenu = 2, SubMenu = "Leitura")]
        RLC_C = 185,
    }
}