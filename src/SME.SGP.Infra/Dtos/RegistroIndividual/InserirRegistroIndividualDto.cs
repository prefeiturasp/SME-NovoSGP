...
{
    public class InserirRegistroIndividualDto
    {
    ...
    public class InserirRegistroIndividualDtoValidator : AbstractValidator<InserirRegistroIndividualDto>
    {
        public InserirRegistroIndividualDtoValidator()
        {
            RuleFor(a => a.TurmaId)
                   .NotEmpty()
