...
import {
  setDadosIniciaisPlanoAEE,
  setDadosSecaoLocalizarEstudante,
  setLimparDadosPlanoAEE,
...
const SecaoLocalizarEstudanteDados = () => {
  ...
  const dadosIniciais = useSelector(
    store => store.planoAEE.dadosIniciaisPlanoAEE
  );
  ...
  useEffect(() => {
    return () => dispatch(setDadosIniciaisPlanoAEE({}));
  }, [dispatch]);
  ...
  const onChangeDre = dre => {
    ...
    setAlunoLocalizadorSelecionado();
    dispatch(setLimparDadosPlanoAEE());
  };
