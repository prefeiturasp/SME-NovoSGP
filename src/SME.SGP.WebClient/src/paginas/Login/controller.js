...
class LoginController {
    ...
    validarDados = Login => {
        ...
        const UsuarioNaoInformado = !Login.usuario || Login.usuario === "" || typeof Login.usuario === "undefined";
        const SenhaNaoInformada = !Login.senha || Login.senha === "" || typeof Login.senha === "undefined";
    ...
    enviarDados = async (Login) => {
        ...
        if (validacao.falha)
            return {
                sucesso: false,
                erroGeral: "Você precisa informar um usuário e senha para acessar o sistema.",
