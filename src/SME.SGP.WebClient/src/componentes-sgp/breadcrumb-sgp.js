...
const BreadcrumbSgp = () => {
  ...
  const UsuarioStrore = useSelector(state => state.usuario);
  ...
  const carregaBreadcrumbs = useCallback(() => {
    const verificaTrocaNomesBreadcrumb = () => {
      if (
        ...
        rotas.get('/planejamento/plano-ciclo').breadcrumbName =
          'Plano de Etapa';
        rotas.get('/planejamento/plano-anual').breadcrumbName =
          'Plano Semestral';
      } else {
        rotas.get('/planejamento/plano-ciclo').breadcrumbName =
          'Plano de Ciclo';
  ...
  useEffect(() => {
    carregaBreadcrumbs();
  }, [NavegacaoStore.rotaAtiva, carregaBreadcrumbs]);

  useEffect(() => {
    carregaBreadcrumbs();
  }, [UsuarioStrore.turmaSelecionada, carregaBreadcrumbs]);
