...
namespace SME.SGP.Dados.Repositorios
{
    public class RepositorioAtribuicaoCJ : RepositorioBase<AtribuicaoCJ>, IRepositorioAtribuicaoCJ
    {
        ...
        public async Task<IEnumerable<AtribuicaoCJ>> ObterAtribuicaoCJPorDreUeTurmaRF(string turmaId, string dreCodigo, string ueCodigo, string professorRf)
        {
            StringBuilder sql = new StringBuilder();
            ...
            return await database.Conexao.QueryAsync<AtribuicaoCJ>(sql.ToString(), new { turmaId, dreCodigo, ueCodigo, professorRf });
        }
