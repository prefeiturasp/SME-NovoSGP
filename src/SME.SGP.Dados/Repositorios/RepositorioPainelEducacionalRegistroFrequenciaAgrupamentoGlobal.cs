...
{
    public class RepositorioPainelEducacionalRegistroFrequenciaAgrupamentoGlobal : IRepositorioPainelEducacionalRegistroFrequenciaAgrupamentoGlobal
    {
        private readonly ISgpContext database;
        private readonly IConfiguration configuration;
        public RepositorioPainelEducacionalRegistroFrequenciaAgrupamentoGlobal(IConfiguration configuration, ISgpContext database)
        {
            this.configuration = configuration;
            this.database = database;
        }

        public async Task BulkInsertAsync(IEnumerable<PainelEducacionalRegistroFrequenciaAgrupamentoGlobal> registros)
        {
        ...
        public async Task<IEnumerable<PainelEducacionalRegistroFrequenciaAgrupamentoGlobal>> ObterFrequenciaGlobal(int anoLetivo, string codigoDre, string codigoUe)
        {
            ...
            return await database.QueryAsync<PainelEducacionalRegistroFrequenciaAgrupamentoGlobal>(sql, new { anoLetivo, codigoDre, codigoUe });
        }
    }
}
