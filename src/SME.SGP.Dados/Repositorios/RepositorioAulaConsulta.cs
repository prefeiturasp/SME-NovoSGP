...
namespace SME.SGP.Dados.Repositorios
{
    ...
    {
        public RepositorioAulaConsulta(ISgpContextConsultas conexao, IServicoMensageria servicoMensageria) : base(conexao, servicoMensageria)
        {
        }
        ...
        public async Task<bool> ExisteAulaNaDataDataTurmaDisciplinaProfessorRfAsync(DateTime data, string turmaCodigo, string componenteCurricular, string professorRf, TipoAula tipoAula)
        {
            var query = @"select 1
                 from aula
                where not excluido
        ...
        public Task<IEnumerable<Aula>> ObterAulasPorDataPeriodo(DateTime dataInicio, DateTime dataFim, string turmaId, string disciplinaId, bool aulaCj)
        {
