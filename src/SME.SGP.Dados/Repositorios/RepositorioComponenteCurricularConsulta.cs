...
namespace SME.SGP.Dados.Repositorios
{
    public class RepositorioComponenteCurricularConsulta : IRepositorioComponenteCurricularConsulta
    {
        ...
        public async Task<IEnumerable<ComponenteCurricularSimplesDto>> ObterDescricaoPorIds(long[] ids)
        {
            ...
            return await database.Conexao.QueryAsync<ComponenteCurricularSimplesDto>(query, new { ids },queryName: "RepositorioComponenteCurricularConsulta - ObterDescricaoPorIds");
        }
