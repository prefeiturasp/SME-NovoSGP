...
namespace SME.SGP.Dados.Repositorios
{
    public class RepositorioPendenciaAulaConsulta : IRepositorioPendenciaAulaConsulta
    {
        ...
        {
            var query = @"select a.data_aula as DataAula, pa.Motivo, (a.tipo_aula = 2) ehReposicao, a.turma_id TurmaId, a.ue_id UeId, a.disciplina_id DisciplinaId, aa.nome_avaliacao as TituloAvaliacao
                           from pendencia_aula pa
                           ...
                           left join atividade_avaliativa aa on aa.turma_id = a.turma_id 
									...
									and a.professor_rf = aa.professor_rf and p.tipo = 10                           
                          where pa.pendencia_id = @pendenciaId
