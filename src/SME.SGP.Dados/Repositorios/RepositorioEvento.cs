...
namespace SME.SGP.Dados.Repositorios
{
    public class RepositorioEvento : RepositorioBase<Evento>, IRepositorioEvento
    {
        ...
        public async Task<IEnumerable<Evento>> ObterEventosCalendarioPorDia(long tipoCalendarioId, string dreCodigo, string ueCodigo,
            DateTime dataDoEvento, bool VisualizarEventosSME = false, bool podeVisualizarEventosLibExcepRepoRecessoGestoresUeDreSme = false)

        {
            ...
            return await database.Conexao.QueryAsync<Evento>(query.ToString(), param: new
            {
                tipoCalendarioId,
                dreCodigo,
                ueCodigo,
