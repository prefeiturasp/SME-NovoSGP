...
{
    public class RepositorioNovoEncaminhamentoNAAPAHistoricoAlteracoes : Dominio.Interfaces.Repositorios.IRepositorioNovoEncaminhamentoNAAPAHistoricoAlteracoes
    {
        protected readonly ISgpContext database;

        public RepositorioNovoEncaminhamentoNAAPAHistoricoAlteracoes(ISgpContext database)
        {
        ...
        public async Task<PaginacaoResultadoDto<NovoEncaminhamentoNAAPAHistoricoDeAlteracaoDto>> ListarPaginadoPorEncaminhamentoNAAPAId(long encaminhamentoNAAPAId, Paginacao paginacao)
        {
            var retorno = new PaginacaoResultadoDto<NovoEncaminhamentoNAAPAHistoricoDeAlteracaoDto>();
            ...
            {
                retorno.Items = historicoAlteracoes.Read<NovoEncaminhamentoNAAPAHistoricoDeAlteracaoDto>();
