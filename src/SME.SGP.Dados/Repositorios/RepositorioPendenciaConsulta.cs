...
namespace SME.SGP.Dados.Repositorios
{
    public class RepositorioPendenciaConsulta : RepositorioBase<Pendencia>, IRepositorioPendenciaConsulta
    {
       ...
       string tituloPendencia, string turmaCodigo, Paginacao paginacao)
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioPerfil(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
            ...
            return resultado.Select(r => new Pendencia
            {
                Id = r?.id,
                Titulo = r?.titulo,
                Descricao = r?.descricao,
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioAula(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioProfessor(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioFechamento(long usuarioId)
        {
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioDiarioBordo(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioDevolutiva(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioEncaminhamentoAEE(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
        ...
        public async Task<IEnumerable<Pendencia>> ListarPendenciasUsuarioPlanoAEE(long usuarioId)
        {
            const SituacaoPendencia situacao = SituacaoPendencia.Pendente;
