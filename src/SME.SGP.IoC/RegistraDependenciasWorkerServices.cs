...
namespace SME.SGP.IoC
{
    public static class RegistraDependenciasWorkerServices
    {
        ...
        private static void RegistrarRepositorios(IServiceCollection services)
        {
            ...
            services.TryAddScopedWorkerService<IRepositorioRegistroFrequenciaAlunoConsulta, RepositorioRegistroFrequenciaAlunoConsulta>();
        ...
        private static void RegistrarCasosDeUso(IServiceCollection services)
        {
            ...
            services.TryAddScopedWorkerService<IConciliacaoFrequenciaTurmasPorPeriodoUseCase, ConciliacaoFrequenciaTurmasPorPeriodoUseCase>();
