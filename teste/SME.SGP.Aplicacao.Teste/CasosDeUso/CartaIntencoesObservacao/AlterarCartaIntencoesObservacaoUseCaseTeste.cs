...
namespace SME.SGP.Aplicacao.Teste.CasosDeUso
{
    public class AlterarCartaIntencoesObservacaoUseCaseTeste
    {
        ...
        {
            //Arrange
            mediator.Setup(a => a.Send(It.IsAny<AlterarCartaIntencaoObservacaoCommand>(), It.IsAny<CancellationToken>()))
            ...
            //Asert
            mediator.Verify(x => x.Send(It.IsAny<AlterarCartaIntencaoObservacaoCommand>(), It.IsAny<CancellationToken>()), Times.Once);
