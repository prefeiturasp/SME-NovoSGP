...
{
    public class ImportacaoArquivoIdepUseCaseTeste
    {
        ...
        private readonly ImportacaoArquivoIdepUseCase useCase;

        public ImportacaoArquivoIdepUseCaseTeste()
        {
            mediatorMock = new Mock<IMediator>();
            repoImportacaoLogMock = new Mock<IRepositorioImportacaoLog>();
            repoUeMock = new Mock<IRepositorioUeConsulta>();

            useCase = new ImportacaoArquivoIdepUseCase(
                mediatorMock.Object,
