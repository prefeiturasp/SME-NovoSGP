...
{
    public class CriarPlanoAEEObservacaoUseCaseTeste
    {
        private readonly Mock<IMediator> _mediatorMock;
        private readonly CriarPlanoAEEObservacaoUseCase _useCase;

        public CriarPlanoAEEObservacaoUseCaseTeste()
        {
            _mediatorMock = new Mock<IMediator>();
            _useCase = new CriarPlanoAEEObservacaoUseCase(_mediatorMock.Object);
        }
        ...
        public async Task Executar_Quando_Dto_Valido_Deve_Enviar_Comando_E_Retornar_Auditoria_()
        {
            ...
            var auditoriaRetorno = new AuditoriaDto { Id = 1, CriadoEm = DateTime.Now };

            _mediatorMock.Setup(m => m.Send(
                It.Is<CriarPlanoAEEObservacaoCommand>(c =>
