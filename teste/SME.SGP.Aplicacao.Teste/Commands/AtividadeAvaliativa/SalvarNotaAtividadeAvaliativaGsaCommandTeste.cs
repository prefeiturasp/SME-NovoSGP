...
namespace SME.SGP.Aplicacao.Teste.Commands.AtividadeAvaliativa
{
    public class SalvarNotaAtividadeAvaliativaGsaCommandValidatorTeste
    {
        ...
        [Fact]
        public void Deve_Falhar_Se_Nota_For_Menor_Que_Zero()
        {
            var comando = new SalvarNotaAtividadeAvaliativaGsaCommand(
                notaConceito: CriarNotaConceitoValida(),
                nota: -1,
            ...
            resultado.Errors.Should().Contain(e => e.PropertyName == "Nota");
        }
        ...
        [Fact]
        public void Deve_Falhar_Se_CodigoAluno_For_Vazio()
        {
            var comando = new SalvarNotaAtividadeAvaliativaGsaCommand(
                notaConceito: CriarNotaConceitoValida(),
                nota: 7.5,
            ...
            resultado.IsValid.Should().BeFalse();
            resultado.Errors.Should().ContainSingle(e => e.PropertyName == "CodigoAluno");
        }
    }
}
