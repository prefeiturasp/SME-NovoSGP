...
namespace SME.SGP.Aplicacao.Teste.Queries.Nota.VerificaNotasTodosComponentesCurriculares
{
    public class VerificaNotasTodosComponentesCurricularesQueryHandlerTeste
    {
        ...
        public async Task Verifica_Se_Ha_Nota_Somente_Para_Turmas_Ativas_No_Periodo()
        {
            ...
            {
                new TurmaItinerarioEnsinoMedioDto(){ Id = 1, Nome = "1", Serie = 4 }
            };
            var listaAlunoTurmaResposta = new List<AlunoPorTurmaResposta>
            {
                new AlunoPorTurmaResposta(){ CodigoAluno = "123", CodigoTurma = 1234, CodigoSituacaoMatricula = SituacaoMatriculaAluno.Rematriculado, DataSituacao = new DateTime(2023, 11, 21), DataMatricula = new DateTime(2023, 11, 17) },
                new AlunoPorTurmaResposta(){ CodigoAluno = "123", CodigoTurma = 2, CodigoSituacaoMatricula = SituacaoMatriculaAluno.Transferido, DataSituacao = new DateTime(2023, 08, 17), DataMatricula = new DateTime(2023, 08, 16)  },
                new AlunoPorTurmaResposta(){ CodigoAluno = "123", CodigoTurma = 12345, CodigoSituacaoMatricula = SituacaoMatriculaAluno.Concluido, DataSituacao = new DateTime(2023, 06, 28), DataMatricula = new DateTime(2023, 03, 07)  },
            };
            ...
            {
                new NotaConceitoBimestreComponenteDto(){AlunoCodigo = "123", ComponenteCurricularCodigo = 1, Nota = 5, Bimestre = 2, ComponenteCurricularNome = "1"},
            };
            var disciplinaDto = new List<DisciplinaDto>
            {
                new DisciplinaDto(){Id = 1, CodigoComponenteCurricular = 1, LancaNota =true, Nome = "1" ,Professor ="123456",TurmaCodigo = "1234"},
            };
            ...
            //Act
            var resultado = await verificaNotasTodosComponentesCurricularesQueryHandler.Handle(verificaNotasTodosComponentesCurricularesQuery, new CancellationToken());
