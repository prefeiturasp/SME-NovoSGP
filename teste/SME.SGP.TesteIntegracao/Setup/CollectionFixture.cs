...
namespace SME.SGP.TesteIntegracao.Setup
{
    public class CollectionFixture : IDisposable
    {
        ...
        public void RegistrarFakes(IServiceCollection services)
        {
        ...
        public void RegistrarQueryFakes(IServiceCollection services)
        {
        ...
        {
            return Database.InserirAsync(objeto);
        }
        ...
        {
            var registros = Database.ObterTodos<T>();
        ...
        private void RegistrarCommandFakes(IServiceCollection services)
        {
