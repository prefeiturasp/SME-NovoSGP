...
namespace SME.SGP.TesteIntegracao.PlanoAula
{
    public class Ao_registrar_plano_aula_com_atribuicao_encerrada: PlanoAulaTesteBase
    {
        ...
        protected override void RegistrarFakes(IServiceCollection services)
        {
            ...
            RegistraFake(typeof(IRequestHandler<ObterUsuarioPossuiPermissaoNaTurmaEDisciplinaQuery, bool>), typeof(ObterUsuarioPossuiPermissaoNaTurmaEDisciplinaQueryHandlerSemPermissaoFake));
        ...
        public async Task Nao_deve_cadastrar_plano_aula_componente_diferente_regencia_com_objetivos_aprendizagem()
        {
            ...
            //var dto = salvarPlanoAulaUseCase.Executar(planoAulaDto);
            //dto.ShouldNotBeNull();
        }
