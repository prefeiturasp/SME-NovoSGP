...
namespace SME.SGP.TesteIntegracao.EncaminhamentoAee
{
    public class Ao_cadastrar_encaminhamento_sim : EncaminhamentoAEETesteBase
    {
        ...
        [Fact(DisplayName = "Encaminhamento AEE - Professor deve cadastrar encaminhamento com preenchimento correto dos campos obrigatórios")]
        ...
        [Fact(DisplayName = "Encaminhamento AEE - Professor deve cadastrar encaminhamento com preenchimento correto dos campos obrigatórios e omissão de campos não obrigatórios")]
        ...
        [Fact(DisplayName = "Encaminhamento AEE - Professor não deve cadastrar encaminhamento quando não preencher campos obrigatórios")]
