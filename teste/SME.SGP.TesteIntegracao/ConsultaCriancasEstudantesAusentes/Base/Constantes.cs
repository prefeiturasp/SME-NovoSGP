...
namespace SME.SGP.TesteIntegracao.ConsultaCriancasEstudantesAusentes.Base
{
    public class Constantes
    {
        ...
        public DateTime DATA_03_01_INICIO_BIMESTRE_1 = new(DateTimeExtension.HorarioBrasilia().Year, 01, 01);
        ...
        public  long ATIVIDADE_AVALIATIVA_1 = 1;
        public  long ATIVIDADE_AVALIATIVA_2 = 2;
        ...
        public  DateTime DATA_16_09 = new(DateTimeExtension.HorarioBrasilia().Year, 09, 16);
        public  DateTime DATA_30_09 = new(DateTimeExtension.HorarioBrasilia().Year, 09, 30);

        public  DateTime DATA_01_10 = new(DateTimeExtension.HorarioBrasilia().Year, 10, 01);
        public  DateTime DATA_03_10 = new(DateTimeExtension.HorarioBrasilia().Year, 10, 03);
        public  DateTime DATA_22_12 = new(DateTimeExtension.HorarioBrasilia().Year, 12, 22);

        public  DateTime DATA_01_01 = new(DateTimeExtension.HorarioBrasilia().Year, 01, 01);
        public  DateTime DATA_01_01_ANO_ANTERIOR = new(DateTimeExtension.HorarioBrasilia().AddYears(-1).Year, 01, 01);

        public  DateTime DATA_31_12 = new(DateTimeExtension.HorarioBrasilia().Year, 12, 31);
        public  DateTime DATA_31_12_ANO_ANTERIOR = new(DateTimeExtension.HorarioBrasilia().AddYears(-1).Year, 12, 31);

        public  DateTime DATA_10_01 = new(DateTimeExtension.HorarioBrasilia().Year, 01, 10);

        public  DateTime DATA_24_01 = new(DateTimeExtension.HorarioBrasilia().Year, 01, 24);
        ...
        public  string ALUNO_CODIGO_3 = "3";
        public  string ALUNO_CODIGO_4 = "4";
        public  string ALUNO_CODIGO_5 = "5";
        public  string ALUNO_CODIGO_6 = "6";
        public  string ALUNO_CODIGO_7 = "7";
        public  string ALUNO_CODIGO_8 = "8";
        public  string ALUNO_CODIGO_9 = "9";
        public  string ALUNO_CODIGO_10 = "10";
        public  string ALUNO_CODIGO_11 = "11";
        public  string ALUNO_CODIGO_12 = "12";
        public  string ALUNO_CODIGO_13 = "13";
