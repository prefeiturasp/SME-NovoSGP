...
namespace SME.SGP.TesteIntegracao.Nota
{
    public class Ao_registrar_nota_para_professor_cj : NotaBase
    {
        ...
        public async Task Ao_lancar_nota_numerica_pelo_professor_cj_com_avaliacoes_do_professor_titular_do_cj()
        {
            ...
            await CriarAtividadeAvaliativa(DATA_02_05_INICIO_BIMESTRE_2, COMPONENTE_REG_CLASSE_SP_INTEGRAL_1A5_ANOS_ID_1213.ToString(), USUARIO_PROFESSOR_LOGIN_2222222);
            await CriarAtividadeAvaliativa(DATA_02_05_INICIO_BIMESTRE_2, COMPONENTE_REG_CLASSE_SP_INTEGRAL_1A5_ANOS_ID_1213.ToString(), USUARIO_PROFESSOR_LOGIN_1111111);
