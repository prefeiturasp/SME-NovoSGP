...
namespace SME.SGP.TesteIntegracao.PlanoAEE
{
    public class Ao_realizar_devolucao : PlanoAEETesteBase
    {
        ...
        protected override void RegistrarFakes(IServiceCollection services)
        {
            ...
            services.Replace(new ServiceDescriptor(typeof(IRequestHandler<ObterProfessoresTitularesDaTurmaCompletosQuery, IEnumerable<ProfessorTitularDisciplinaEol>>), typeof(ObterProfessoresTitularesDaTurmaCompletosQueryHandlerFake), ServiceLifetime.Scoped));
        }
