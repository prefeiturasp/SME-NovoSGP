...
namespace SME.SGP.TesteIntegracao.PlanoAEE
{
    public class Ao_realizar_devolucao : PlanoAEETesteBase
    {
        ...
        protected override void RegistrarFakes(IServiceCollection services)
        {
            ...
            services.Replace(new ServiceDescriptor(typeof(IRequestHandler<ObterAlunoPorCodigoEAnoPlanoAeeQuery, AlunoReduzidoDto>), typeof(ObterAlunoPorCodigoEAnoPlanoAeeQueryHandler), ServiceLifetime.Scoped));
