...
{
    public class ObterComponentesCurricularesEOLComSemAgrupamentoTurmaQueryHandlerFakeServicoEol : IRequestHandler<ObterComponentesCurricularesEOLComSemAgrupamentoTurmaQuery, IEnumerable<DisciplinaDto>>
    {
