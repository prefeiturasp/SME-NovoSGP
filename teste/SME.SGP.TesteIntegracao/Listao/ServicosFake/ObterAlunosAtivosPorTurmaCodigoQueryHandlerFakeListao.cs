...
{
    public class ObterAlunosAtivosPorTurmaCodigoQueryHandlerFakeListao : IRequestHandler<ObterAlunosAtivosPorTurmaCodigoQuery, IEnumerable<AlunoPorTurmaResposta>>
    {
