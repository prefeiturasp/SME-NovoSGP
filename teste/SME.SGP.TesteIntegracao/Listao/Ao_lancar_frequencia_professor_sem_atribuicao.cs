...
{
    public class Ao_lancar_frequencia_professor_sem_atribuicao : ListaoTesteBase
    {
        public Ao_lancar_frequencia_professor_sem_atribuicao(CollectionFixture collectionFixture) : base(collectionFixture)
        {
        }
