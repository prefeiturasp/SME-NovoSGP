...
{
    public class PublicarFilaSgpCommandExecutarConsolidadoAtendimentoProfissionalAtendimentoNAAPAUseCase : IRequestHandler<PublicarFilaSgpCommand, bool>
    {
        ...
        public PublicarFilaSgpCommandExecutarConsolidadoAtendimentoProfissionalAtendimentoNAAPAUseCase(IExecutarInserirConsolidadoAtendimentoProfissionalAtendimentoNAAPAUseCase executarInserirConsolidadoAtendimentoProfissionalEncaminhamentoNAAPAUseCase, IExecutarExcluirConsolidadoAtendimentoProfissionalAtendimentoNAAPAUseCase executarExcluirConsolidadoAtendimentoProfissionalEncaminhamentoNAAPAUseCase)
        {
