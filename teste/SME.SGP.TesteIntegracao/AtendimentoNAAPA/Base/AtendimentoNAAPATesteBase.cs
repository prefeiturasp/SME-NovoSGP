...
{
    public class AtendimentoNAAPATesteBase : TesteBaseComuns
    {
        protected const string MOTIVO_ENCERRAMENTO = "Motivo do encerramento do atendimento NAAPA";
        ...
        public AtendimentoNAAPATesteBase(CollectionFixture collectionFixture) : base(collectionFixture)
        {
        }
        ...
        private async Task CriarSecaoEncaminhamentoNAAPAQuestionario()
        {
            ...
            await InserirNaBase(new SecaoEncaminhamentoNAAPA()
            {
                ...
                NomeComponente = AtendimentoNAAPAConstants.SECAO_ITINERANCIA,
                Etapa = 1,
                Ordem = 3,
                CriadoPor = SISTEMA_NOME,
                CriadoRF = SISTEMA_CODIGO_RF,
