...
{
    public class Ao_obter_campos_historico_alteracao_encaminhamento_naapa : AtendimentoNAAPATesteBase
    {
        ...
        public async Task Ao_obter_campos_historico_alteracao_campo_resposta_texto()
        {
            ...
            var historico = await mediator.Send(new ObterHistoricosDeAlteracoesAtendimentoNAAPAQuery(secaoDto, encaminhamento.Secoes.FirstOrDefault(), TipoHistoricoAlteracoesAtendimentoNAAPA.Alteracao));
        ...
        public async Task Ao_obter_campos_historico_alteracao_campo_resposta_id()
        {
            ...
            var historico = await mediator.Send(new ObterHistoricosDeAlteracoesAtendimentoNAAPAQuery(secaoDto, secao, TipoHistoricoAlteracoesAtendimentoNAAPA.Alteracao));
