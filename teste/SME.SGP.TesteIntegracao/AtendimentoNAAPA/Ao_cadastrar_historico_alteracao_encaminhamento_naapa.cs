...
{
    public class Ao_cadastrar_historico_alteracao_encaminhamento_naapa : AtendimentoNAAPATesteBase
    {
        ...
        public async Task Ao_cadastrar_historico_alteracao_secao()
        {
            ...
            await mediator.Send(new RegistrarHistoricoDeAlteracaoAtendimentoNAAPACommand(secaoDto, encaminhamento.Secoes.FirstOrDefault(), TipoHistoricoAlteracoesAtendimentoNAAPA.Alteracao));
        ...
        public async Task Ao_cadastrar_historico_alteracao_ao_imprimir_o_encaminhamento_naapa()
        {
            ...
            historico.TipoHistorico.ShouldBe(TipoHistoricoAlteracoesAtendimentoNAAPA.Impressao);
        }
