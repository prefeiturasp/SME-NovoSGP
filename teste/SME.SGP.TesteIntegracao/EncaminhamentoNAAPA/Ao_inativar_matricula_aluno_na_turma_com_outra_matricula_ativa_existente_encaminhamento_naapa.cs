...
namespace SME.SGP.TesteIntegracao.EncaminhamentoNAAPA
{
    public class Ao_inativar_matricula_aluno_na_turma_com_outra_matricula_ativa_existente_encaminhamento_naapa : EncaminhamentoNAAPATesteBase
    {
        ...
        [Fact(DisplayName = "Encaminhamento NAAPA - Ao receber atualização de situação matrícula do aluno a turma para Inativo porém com outra matrícula ativa, deve atualizar situação matrícula no encaminhamento e não notificar CP NAAPA")]
