...
namespace SME.SGP.TesteIntegracao.EncaminhamentoNAAPA
{
    public class Ao_reabrir_encaminhamento_naapa : EncaminhamentoNAAPATesteBase
    {
        ...
        public async Task Ao_reabrir_encaminhamento_naapa_nao_encerrado()
        {
            ...
            excecao.Message.ShouldBe(MensagemNegocioEncaminhamentoNAAPA.ENCAMINHAMENTO_NAO_PODE_SER_REABERTO_NESTA_SITUACAO);
        }
        ...
        public async Task Ao_reabrir_encaminhamento_naapa_aluno_inativo()
        {
            ...
            excecao.Message.ShouldBe(MensagemNegocioEncaminhamentoNAAPA.ENCAMINHAMENTO_ALUNO_INATIVO_NAO_PODE_SER_REABERTO);
        }
