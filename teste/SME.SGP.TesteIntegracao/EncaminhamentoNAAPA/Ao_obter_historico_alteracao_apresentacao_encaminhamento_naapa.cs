...
{
    public class Ao_obter_historico_alteracao_apresentacao_encaminhamento_naapa : EncaminhamentoNAAPATesteBase
    {
        ...
        public async Task Ao_obter_historico_alteracao_tipo_exclusao_atendimento()
        {
            ...
            historico.TipoHistoricoAlteracoes.ShouldBe(TipoHistoricoAlteracoesEncaminhamentoNAAPA.Exclusao);
        }
