...
{
    public class Ao_excluir_diario_bordo_com_devolutiva : DiarioBordoTesteBase
    {

        public Ao_excluir_diario_bordo_com_devolutiva(CollectionFixture collectionFixture) : base(collectionFixture)
        {
        }
