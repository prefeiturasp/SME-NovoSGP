...
namespace SME.SGP.TesteIntegracao
{
    ...
    public class TesteBase : IClassFixture<TestFixture>
    {
        ...
        public Task InserirNaBaseComCampos(string nomeTabela, string camposDaTabela, params string[] valoresDosCampos)
        {
            _collectionFixture.Database.Inserir(nomeTabela, camposDaTabela, valoresDosCampos);
            return Task.CompletedTask;
        }
