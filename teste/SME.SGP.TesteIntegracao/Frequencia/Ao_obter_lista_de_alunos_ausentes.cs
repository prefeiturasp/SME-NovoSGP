...
namespace SME.SGP.TesteIntegracao.Frequencia
{
    public class Ao_obter_lista_de_alunos_ausentes : FrequenciaTesteBase
    {
        ...
        {
            await CriarDadosBasicos(ObterPerfilProfessor(), Modalidade.Fundamental, ModalidadeTipoCalendario.FundamentalMedio, DATA_02_05, DATA_07_08, BIMESTRE_1, DATA_02_05, COMPONENTE_CURRICULAR_PORTUGUES_ID_138.ToString(), false, NUMERO_AULAS_1);
