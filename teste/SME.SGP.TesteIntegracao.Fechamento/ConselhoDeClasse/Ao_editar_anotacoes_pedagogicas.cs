...
{
    public class Ao_editar_anotacoes_pedagogicas : ConselhoDeClasseTesteBase
    {
        ...
        public Ao_editar_anotacoes_pedagogicas(CollectionFixture collectionFixture) : base(collectionFixture)
        {
        }
        ...
        public async Task Deve_permitir_alterar_anotacoes()
        {
            ...
            dtoAlterado.AnotacoesPedagogicas = ANOTACAO_PEDAGOGICA_EDITADA;
            ...
            retornoAnotacoesEditada.AnotacoesPedagogicas.ShouldNotBeNullOrEmpty();
