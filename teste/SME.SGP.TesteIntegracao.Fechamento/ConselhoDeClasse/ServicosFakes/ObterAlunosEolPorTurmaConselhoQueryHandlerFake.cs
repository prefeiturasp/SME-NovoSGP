...
{
    public class ObterAlunosEolPorTurmaConselhoQueryHandlerFake : IRequestHandler<ObterAlunosEolPorTurmaQuery, IEnumerable<AlunoPorTurmaResposta>>
    {
        ...
        public ObterAlunosEolPorTurmaConselhoQueryHandlerFake()
        {
        }
