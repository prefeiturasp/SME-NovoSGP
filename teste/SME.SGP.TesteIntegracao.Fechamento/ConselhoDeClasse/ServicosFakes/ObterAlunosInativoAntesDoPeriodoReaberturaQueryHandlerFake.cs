...
{
    public class ObterAlunosInativoAntesDoPeriodoReaberturaQueryHandlerFake : IRequestHandler<ObterAlunosPorTurmaEAnoLetivoQuery, IEnumerable<AlunoPorTurmaResposta>>
    {
        ...
        {
            var dataSituacao = new DateTime(DateTimeExtension.HorarioBrasilia().Year, 01, 01).AddDays(-10);
