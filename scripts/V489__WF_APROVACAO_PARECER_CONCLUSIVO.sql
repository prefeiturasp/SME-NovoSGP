...
ALTER TABLE public.wf_aprovacao_parecer_conclusivo ADD CONSTRAINT wf_aprovacao_parecer_conclusivo_usuario_fk FOREIGN KEY (usuario_solicitante_id) REFERENCES usuario(id);
...
CREATE INDEX wf_aprovacao_parecer_conclusivo_usuario_idx ON public.wf_aprovacao_parecer_conclusivo USING btree (usuario_solicitante_id);
