...
select ab_dres.dre_id as dre_codigo, ab_dres.abreviacao as dre_abreviacao, ab_dres.nome as dre_nome, 
	   ...
	   ab_turmas.ano as turma_ano, ab_turmas.ano_letivo as turma_ano_letivo, ab_turmas.modalidade as turma_modalidade, ab_turmas.modalidade_codigo as modalidade_codigo, ab_turmas.nome as turma_nome,
