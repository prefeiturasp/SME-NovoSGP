CREATE OR REPLACE FUNCTION public.f_eventos(p_login character varying, p_perfil_id uuid, p_historico boolean, p_tipo_calendario_id bigint, p_considera_pendente_aprovacao boolean DEFAULT false, p_desconsidera_local_dre boolean DEFAULT false, p_dre_id character varying DEFAULT NULL::character varying, p_ue_id character varying DEFAULT NULL::character varying, p_desconsidera_liberacao_excep_reposicao_recesso boolean DEFAULT false, p_data_inicio date DEFAULT NULL::date, p_data_fim date DEFAULT NULL::date, p_eh_perfil_sme boolean DEFAULT false, p_eh_perfil_dre boolean DEFAULT false, p_eh_perfil_ue boolean DEFAULT false, p_eh_eventos_toda_rede boolean DEFAULT false)
...
where not e.excluido
  ...
  and (
        ...
        or
        (p_eh_perfil_dre
            and ((p_ue_id is null and (p_dre_id = e.dre_id or (e.dre_id is null and e.ue_id is null)))
