...
CREATE OR REPLACE FUNCTION public.f_abrangencia_modalidades(p_login character varying, p_perfil_id uuid, p_historico boolean, p_ano_letivo integer, p_ignorar_modalidades integer[] DEFAULT NULL::integer[], p_ue_codigo character varying DEFAULT NULL::character varying)
...
where a.login = p_login and 
	  ...
	  and (p_ue_codigo is null or (p_ue_codigo is not null and act.ue_codigo = p_ue_codigo))
