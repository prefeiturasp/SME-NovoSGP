...
create or replace function f_eventos(p_login character varying, p_perfil_id uuid, p_historico boolean, p_tipo_calendario_id bigint, p_considera_pendente_aprovacao boolean DEFAULT false, p_desconsidera_local_dre boolean DEFAULT false, p_dre_id character varying DEFAULT NULL::character varying, p_ue_id character varying DEFAULT NULL::character varying, p_desconsidera_liberacao_excep_reposicao_recesso boolean DEFAULT false, p_data_inicio date DEFAULT NULL::date, p_data_fim date DEFAULT NULL::date, p_eh_perfil_sme boolean DEFAULT false,p_eh_perfil_dre boolean DEFAULT false, p_eh_perfil_ue boolean DEFAULT false) returns SETOF v_estrutura_eventos
    language sql
as
$$
select e.id,
...
alter function f_eventos(varchar, uuid, boolean, bigint, boolean, boolean, varchar, varchar, boolean, date, date, boolean,boolean,boolean) owner to postgres;


create or replace function f_eventos_listar_sem_paginacao(p_login character varying, p_perfil_id uuid, p_historico boolean, p_tipo_calendario_id bigint, p_considera_pendente_aprovacao boolean DEFAULT false, p_desconsidera_local_dre boolean DEFAULT false, p_dre_id character varying DEFAULT NULL::character varying, p_ue_id character varying DEFAULT NULL::character varying, p_desconsidera_liberacao_excep_reposicao_recesso boolean DEFAULT false, p_data_inicio date DEFAULT NULL::date, p_data_fim date DEFAULT NULL::date, p_tipo_evento_id bigint DEFAULT NULL::bigint, p_nome_evento character varying DEFAULT NULL::character varying, p_eh_perfil_sme  boolean DEFAULT false, p_eh_perfil_dre boolean DEFAULT false, p_eh_perfil_ue boolean DEFAULT false) returns SETOF v_estrutura_eventos_listar
    language sql
as
$$
select eventoid,
...
from (
         select eventoid,
                ...
                descricaotipoevento,
                excluido
         from f_eventos(p_login, p_perfil_id, p_historico, p_tipo_calendario_id, p_considera_pendente_aprovacao, p_desconsidera_local_dre, p_dre_id, p_ue_id, p_desconsidera_liberacao_excep_reposicao_recesso, p_data_inicio, p_data_fim, p_eh_perfil_sme, p_eh_perfil_dre, p_eh_perfil_ue)
         ...
         select eventoid,
                ...
                descricaotipoevento,
                excluido
         from f_eventos_por_rf_criador(p_login, p_tipo_calendario_id, p_dre_id, p_ue_id, p_data_inicio, p_data_fim, p_eh_perfil_sme, p_eh_perfil_dre, p_eh_perfil_ue)) lista
...
alter function f_eventos_listar_sem_paginacao(varchar, uuid, boolean, bigint, boolean, boolean, varchar, varchar, boolean, date, date, bigint, varchar, boolean, boolean, boolean) owner to postgres;
