...
begin
	...
	insert into questao(questionario_id, ordem, nome, placeholder, observacao, obrigatorio, tipo, opcionais, criado_em, criado_por, criado_rf, dimensao, tamanho, mascara)
		values(questionarioId, 1, 'Prioridade', 'Prioridade', '', true, 4, '', NOW(), 'SISTEMA', '0', 3, null, null)
	...
	insert into questao(questionario_id, ordem, nome, placeholder, observacao, obrigatorio, tipo, opcionais, criado_em, criado_por, criado_rf, dimensao, tamanho, mascara)
		values(questionarioId, 2, 'Porta de entrada', 'Porta de entrada', '', true, 4, '', NOW(), 'SISTEMA', '0', 6, null, null)
		RETURNING id INTO questaoId;
	...
	insert into questao(questionario_id, ordem, nome, placeholder, observacao, obrigatorio, tipo, opcionais, criado_em, criado_por, criado_rf, dimensao, tamanho, mascara)
		values(questionarioId, 8, 'Gênero', 'Gênero', '', true, 4, '', NOW(), 'SISTEMA', '0', 6, null, null)
		RETURNING id INTO questaoId;
