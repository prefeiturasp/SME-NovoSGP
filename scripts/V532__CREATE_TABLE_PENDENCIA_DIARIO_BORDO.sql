...
CREATE INDEX pendencia_diario_bordo_diario_idx ON public.pendencia_diario_bordo USING btree (diario_bordo_id);
...
ALTER TABLE public.pendencia_diario_bordo ADD constraint pendencia_diario_bordo_diario_fk FOREIGN KEY (diario_bordo_id) REFERENCES public.diario_bordo(id);