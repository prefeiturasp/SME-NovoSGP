...
select
	'PercentualFrequenciaMinimaInfantil','Percentual de frequência mínima da educação infantil para envio da notificação bimestral','60','2019',now(),'Carga Inicial','Carga Inicial',27
where
	not exists(
	select
		1
