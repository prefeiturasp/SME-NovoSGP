...
create or replace function f_ata_final_obter_notas_turmas_alunos(p_ano_letivo int DEFAULT 2021, p_modalidade_codigo integer[] DEFAULT NULL::integer[], p_semestre int DEFAULT 0, p_tipos_turma integer[] DEFAULT NULL::integer[], p_alunos_codigos varchar(15)[] DEFAULT NULL::varchar(15)[])
