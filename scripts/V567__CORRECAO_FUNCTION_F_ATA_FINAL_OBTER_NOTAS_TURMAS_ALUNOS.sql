...
CREATE OR REPLACE FUNCTION public.f_ata_final_obter_notas_turmas_alunos(p_ano_letivo integer DEFAULT 2021, p_modalidade_codigo integer[] DEFAULT NULL::integer[], p_semestre integer DEFAULT 0, p_tipos_turma integer[] DEFAULT NULL::integer[], p_alunos_codigos character varying[] DEFAULT NULL::character varying(15)[])
...
from
	...
	where
		...
		and (p_modalidade_codigo is null or (array_length(p_modalidade_codigo, 1) > 0 and t.modalidade_codigo = any(p_modalidade_codigo)))
