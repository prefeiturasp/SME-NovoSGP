...
--insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(20,1,'Adm COPED','',now(),'Carga','Carga');
...
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(200,3,'Diretor','46E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(210,3,'AD','45E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(220,3,'CP','44E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(230,3,'Secretário','43E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(240,3,'Adm UE','42E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(250,3,'ATE','3BE1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(260,3,'POA','3FE1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(270,3,'Professor','40E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(280,3,'PAEE','3DE1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(290,3,'PAP','3EE1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(300,3,'Professor CJ','41E1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
insert into public.prioridade_perfil (ordem,tipo,nome_perfil,codigo_perfil,criado_em,criado_por,criado_rf) values(310,3,'Professor Readaptado','3CE1E074-37D6-E911-ABD6-F81654FE895D',now(),'Carga','Carga');
