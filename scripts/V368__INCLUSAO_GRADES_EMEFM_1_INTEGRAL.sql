...
begin
	...
	--EMEFM - 1 Serie integral
	insert into grade (nome, criado_em, criado_por, criado_rf)
	values('EMEFM - 1ª Série - Integral', now(), 'Carga', 'Carga') returning id into gradeId;
	...
	--Língua Portuguesa
	insert into grade_disciplina (grade_id, ano, componente_curricular_id, quantidade_aulas, criado_em, criado_por, criado_rf)
	values (gradeId, 1, 1329, 1, now(), 'Carga', 'Carga');
	...
	insert into grade_disciplina (grade_id, ano, componente_curricular_id, quantidade_aulas, criado_em, criado_por, criado_rf)
	values (gradeId, 1, 1346, 2, now(), 'Carga', 'Carga');

	--Expressões Culturais e Artísticas
	insert into grade_disciplina (grade_id, ano, componente_curricular_id, quantidade_aulas, criado_em, criado_por, criado_rf)
	values (gradeId, 1, 1340, 1, now(), 'Carga', 'Carga');
