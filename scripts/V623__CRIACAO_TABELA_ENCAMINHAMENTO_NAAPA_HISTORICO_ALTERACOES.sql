...
atendimento_excluido varchar(10) NULL,
...
CONSTRAINT encaminhamento_naapa_historico_alteracoes_naapa_secao_id_fk FOREIGN KEY (encaminhamento_naapa_secao_id) REFERENCES encaminhamento_naapa_secao(id),
...
CREATE index if not exists encaminhamento_naapa_historico_alteracoes_secao_id_ix ON encaminhamento_naapa_historico_alteracoes USING btree (encaminhamento_naapa_secao_id);
