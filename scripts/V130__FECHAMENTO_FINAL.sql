CREATE table if not exists public.fechamento_final (
                id int8 NOT NULL GENERATED ALWAYS AS identity,
                
                ausencias_compensadas int  NOT NULL,
...
CREATE INDEX fechamento_final_aluno_idx ON public.fechamento_final USING btree (aluno_codigo);
CREATE INDEX fechamento_final_disciplina_idx ON public.fechamento_final USING btree (disciplina_codigo);
