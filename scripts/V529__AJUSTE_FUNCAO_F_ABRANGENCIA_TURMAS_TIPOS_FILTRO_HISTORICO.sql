drop function if exists public.f_abrangencia_turmas_tipos;
CREATE OR REPLACE FUNCTION public.f_abrangencia_turmas_tipos(p_login character varying, p_perfil_id uuid, p_historico boolean, p_modalidade_codigo integer DEFAULT 0, p_turma_semestre integer DEFAULT 0, p_ue_codigo character varying DEFAULT NULL::character varying, p_ano_letivo integer DEFAULT 0, p_tipos_turma integer[] DEFAULT NULL::integer[], p_anos_desconsiderar_turma_infantil text[] DEFAULT NULL::text[])
