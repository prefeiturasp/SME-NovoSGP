...
begin
	...
	--EMEBS - 1ª Série - Noturno
	insert into grade (nome, criado_em, criado_por, criado_rf)
	values('EMEBS - 1ª Série - Noturno', now(), 'Carga', 'Carga') returning id into gradeId;
	...
	--Filosofia
	insert into grade_disciplina (grade_id, ano, componente_curricular_id, quantidade_aulas, criado_em, criado_por, criado_rf)
	values (gradeId, 1, 98, 1, now(), 'Carga', 'Carga');
	...
	--Química
	insert into grade_disciplina (grade_id, ano, componente_curricular_id, quantidade_aulas, criado_em, criado_por, criado_rf)
	values (gradeId, 1, 52, 1, now(), 'Carga', 'Carga');
